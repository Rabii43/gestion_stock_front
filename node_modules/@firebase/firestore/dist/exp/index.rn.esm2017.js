...
import { base64 as c, getUA as u, isMobileCordova as a, isReactNative as h, isElectron as l, isIE as _, isUWP as f, isBrowserExtension as d } from "@firebase/util";
...
class $ {
    ...
    getToken() {
        ...
        this.getToken()) : e ? (N("string" == typeof e.accessToken), new M(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
    }
    _() {
        this.forceRefresh = !0;
    }
...
class H {
     ...
     */
    constructor(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new k(O.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new k(O.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new k(O.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new k(O.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ class X extends Y {
     ...
     */    static nt(...t) {
        ...
        const e = [];
        for (const n of t) {
            if (n.indexOf("//") >= 0) throw new k(O.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`);
...
/** A dot-separated path for navigating sub-objects within a document. */ class tt extends Y {
     ...
     */    static ct(t) {
        ...
        let n = "", s = 0;
        const i = () => {
            if (0 === n.length) throw new k(O.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            e.push(n), n = "";
        };
        let r = !1;
        for (;s < t.length; ) {
            const e = t[s];
            if ("\\" === e) {
                if (s + 1 === t.length) throw new k(O.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                const e = t[s + 1];
                if ("\\" !== e && "." !== e && "`" !== e) throw new k(O.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                n += e, s += 2;
            } else "`" === e ? (r = !r, s++) : "." !== e || r ? (n += e, s++) : (i(), s++);
        }
        if (i(), r) throw new k(O.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new tt(e);
    }
    static st() {
        return new tt([]);
...
function Pt(t, e) {
    ...
    const n = at(t), s = at(e), i = j(n.seconds, s.seconds);
...
function gt(t) {
    ...
    et.at(n).toString()) : "geoPointValue" in t ? `geo(${(e = t.geoPointValue).latitude},${e.longitude})` : "arrayValue" in t ? function(t) {
        let e = "[", n = !0;
 ...
 */ class kt extends Ot {
    ...
    isEqual(t) {
        return t instanceof kt && this.key.isEqual(t.key) && this.version.isEqual(t.version) && this.gt === t.gt && this.hasCommittedMutations === t.hasCommittedMutations && this.Vt.isEqual(t.Vt);
    }
    toString() {
...
class Mt extends Ot {
    ...
    isEqual(t) {
        return t instanceof Mt && t.hasCommittedMutations === this.hasCommittedMutations && t.version.isEqual(this.version) && t.key.isEqual(this.key);
    }
}
...
class jt extends Qt {
    constructor(t, e, n) {
        super(t, e, n), this.key = et.at(n.referenceValue);
    }
    matches(t) {
...
function Ht(t, e) {
    var n;
    return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((t => et.at(t.referenceValue)));
}
 ...
 */ function ie(t, e, n) {
    ...
    for (let i = 0; i < t.position.length; i++) {
        ...
        if (r.field.rt()) s = et.K(et.at(o.referenceValue), n.key); else {
 ...
 */ class Ve {
    ...
    /** Creates a new target data instance with an updated sequence number. */    Mt(t) {
        return new Ve(this.target, this.targetId, this.Ot, t, this.kt, this.lastLimboFreeSnapshotVersion, this.resumeToken);
    }
    /**
     * Creates a new target data instance with an updated resume token and
     * snapshot version.
     */    Ft(t, e) {
        return new Ve(this.target, this.targetId, this.Ot, this.sequenceNumber, e, this.lastLimboFreeSnapshotVersion, t);
    }
    /**
     * Creates a new target data instance with an updated last limbo free
     * snapshot version number.
     */    $t(t) {
        return new Ve(this.target, this.targetId, this.Ot, this.sequenceNumber, this.kt, t, this.resumeToken);
    }
}
 ...
 */ function ve(t, e, n) {
    ...
    }(n, e) : t instanceof Ne ? xe(t, e) : t instanceof Oe ? ke(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        const n = De(t, e), s = Fe(n) + Fe(t.qt);
 ...
 */ function Se(t, e, n) {
    ...
    // applications.
    return t instanceof Ne ? xe(t, e) : t instanceof Oe ? ke(t, e) : n;
}
...
/** Transforms an array value via a remove operation. */ class Oe extends be {
    constructor(t) {
        super(), this.elements = t;
    }
}
...
function Be(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof Ne && e instanceof Ne || t instanceof Oe && e instanceof Oe ? G(t.elements, e.elements, mt) : t instanceof Me && e instanceof Me ? mt(t.qt, e.qt) : t instanceof Ce && e instanceof Ce;
 ...
 */ function Ke(t, e) {
    return void 0 !== t.updateTime ? e instanceof kt && e.version.isEqual(t.updateTime) : void 0 === t.exists || t.exists === e instanceof kt;
}
 ...
 */ function We(t, e, n) {
    return t instanceof Je ? function(t, e, n) {
        ...
        return new kt(t.key, n.version, s, {
        ...
        return new kt(t.key, n.version, i, {
            hasCommittedMutations: !0
        });
 ...
 */ function je(t, e, n, s) {
    return t instanceof Je ? function(t, e, n, s) {
        if (!Ke(t.Wt, e)) return e;
        let i = t.value;
        const r = tn(t.fieldTransforms, n, e);
        i = en(t.fieldTransforms, i, r);
        const o = He(e);
        return new kt(t.key, o, i, {
            gt: !0
        });
    }
    /**
 ...
 *    ignored.
 */ (t, e, s) : t instanceof Ye ? function(t, e, n, s) {
        if (!Ke(t.Wt, e)) return e;
        const i = He(e), r = tn(t.fieldTransforms, n, e), o = Xe(t, e, r);
        return new kt(t.key, i, o, {
            gt: !0
        });
    }
    /**
 ...
 */ function Ge(t, e) {
    return function(t, e) {
        let n = null;
        for (const s of t) {
            const t = e instanceof kt ? e.field(s.field) : void 0, i = De(s.transform, t || null);
 ...
 */ function He(t) {
    return t instanceof kt ? t.version : J.min();
}
...
function Xe(t, e, n) {
    let s;
    return s = e instanceof kt ? e.data() : Ct.empty(), s = function(t, e) {
        const n = new Nt(e);
...
function Ze(t, e, n) {
    ...
    for (let i = 0; i < n.length; i++) {
        ...
        let c = null;
        e instanceof kt && (c = e.field(r.field)), s.push(Se(o, c, n[i]));
    }
    return s;
}
 ...
 */ function tn(t, e, n, s) {
    ...
    for (const s of t) {
        const t = s.transform;
        let r = null;
        n instanceof kt && (r = n.field(s.field)), i.push(ve(t, r, e));
    }
    return i;
}
...
function an(t) {
    ...
    return v("GRPC error has no .code"), O.UNKNOWN;
    switch (t) {
      case on.OK:
        return O.OK;
 ...
 */ class vn {
    ...
    static Fe(t, e) {
        const n = new Map;
        return n.set(t, Sn.$e(t, e)), new vn(J.min(), n, gn(), En(), Pn());
    }
}
 ...
 */ class Sn {
     ...
     */    static $e(t, e) {
        return new Sn(ct.Et, e, Pn(), Pn(), Pn());
    }
}
...
class On {
     ...
     */    fn(t) {
        for (const e of t.Ke) t.Qe instanceof kt ? this.dn(e, t.Qe) : t.Qe instanceof Mt && this.wn(e, t.key, t.Qe);
     ...
     */    gn(t) {
        ...
        this.an.forEach(((n, s) => {
            ...
            if (i) {
                if (n.Le && Kt(i.target)) {
                    ...
                    null !== this.hn.get(e) || this.yn(s, e) || this.wn(s, e, new Mt(e, t));
                }
        ...
        const s = new vn(t, e, this._n, this.hn, n);
    ...
    In(t) {
        let e = this.an.get(t);
        return e || (e = new xn, this.an.set(t, e)), e;
    }
    pn(t) {
        let e = this.ln.get(t);
...
function jn(t, e) {
    return Qn(t.p, e.path);
}

function Gn(t, e) {
    const n = Wn(e);
    if (n.get(1) !== t.p.projectId) throw new k(O.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.p.projectId);
    if (n.get(3) !== t.p.database) throw new k(O.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.p.database);
    return new et(Yn(n));
}
...
function Zn(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Gn(t, e.found.name), s = Kn(e.found.updateTime), i = new Ct({
            mapValue: {
...
function ts(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            const e = void 0 === t.code ? O.UNKNOWN : an(t.code);
 ...
 */ (o);
        n = new Nn(s, i, r, c || null);
    } else if ("documentChange" in e) {
        e.documentChange;
        const s = e.documentChange;
        s.document, s.document.name, s.document.updateTime;
        const i = Gn(t, s.document.name), r = Kn(s.document.updateTime), o = new Ct({
            mapValue: {
                fields: s.document.fields
            }
        }), c = new kt(i, r, o, {}), u = s.targetIds || [], a = s.removedTargetIds || [];
        n = new Dn(u, a, c.key, c);
    } else if ("documentDelete" in e) {
        e.documentDelete;
        const s = e.documentDelete;
        s.document;
        const i = Gn(t, s.document), r = s.readTime ? Kn(s.readTime) : J.min(), o = new Mt(i, r), c = s.removedTargetIds || [];
        n = new Dn([], c, o.key, o);
...
function ns(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Ue.updateTime(Kn(t.updateTime)) : void 0 !== t.exists ? Ue.exists(t.exists) : Ue.Kt();
        ...
        if ("setToServerValue" in e) N("REQUEST_TIME" === e.setToServerValue), n = new Ce; else if ("appendMissingElements" in e) {
            ...
            n = new Oe(t);
        } else "increment" in e ? n = new Me(t, e.increment) : C();
        const s = tt.ct(e.fieldPath);
        return new Le(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
        const i = Gn(t, e.update.name), r = new Ct({
            mapValue: {
...
function rs(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = zn(t, s), n.structuredQuery.from = [ {
        ...
        allDescendants: !0
    } ]) : (n.parent = zn(t, s.G()), n.structuredQuery.from = [ {
        collectionId: s.J()
    } ]);
    const i = function(t) {
...
function os(t) {
    ...
    let u = null;
    n.startAt && (u = hs(n.startAt));
    let a = null;
    return n.endAt && (a = hs(n.endAt)), ce(e, i, o, r, c, "F" /* First */ , u, a);
}
...
function us(t) {
    return t ? void 0 !== t.unaryFilter ? [ Es(t) ] : void 0 !== t.fieldFilter ? [ ws(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => us(t))).reduce(((t, e) => t.concat(e))) : C() : [];
}
...
function ws(t) {
    return Qt.create(ds(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
 ...
 */ class As {
    ...
    next(t, e) {
        return this.Nn && C(), this.Nn = !0, this.Cn ? this.error ? this.xn(e, this.error) : this.On(t, this.result) : new As(((n, s) => {
            this.Sn = e => {
    ...
    On(t, e) {
        return t ? this.Mn((() => t(e))) : As.resolve(e);
    }
    xn(t, e) {
        return t ? this.Mn((() => t(e))) : As.reject(e);
    }
    static resolve(t) {
        return new As(((e, n) => {
            e(t);
 ...
 */ class Ps {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Ps.Un(u()) && v("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return b("SimpleDb", "Removing database:", t), bs(window.indexedDB.deleteDatabase(t)).kn();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static Kn() {
        ...
        // Check the UA string to find out the browser.
                const t = u(), e = Ps.Un(t), n = 0 < e && e < 10, s = Ps.Wn(t), i = 0 < s && s < 4.5;
        // IE 10
     ...
     */    async zn(t) {
        return this.db || (b("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new k(O.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new gs(t, s));
            }, s.onupgradeneeded = t => {
...
class Ds {
     ...
     */    cancel(t) {
        null !== this.Ts && (this.clearTimeout(), this.ws.reject(new k(O.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    Is() {
 ...
 */ function Cs(t, e) {
    if (v("AsyncQueue", `${e}: ${t}`), ys(t)) return new k(O.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
...
function Os(t) {
    let e = "";
    for (let n = 0; n < t.length; n++) e.length > 0 && (e = Ms(e)), e = ks(t.get(n), e);
    return Ms(e);
}
...
/** Encodes a path separator into the given result */ function Ms(t) {
    return t + "";
}
 ...
 */ class si {
     ...
     */    Ds(t, e) {
        ...
        for (const n of this.baseMutations) n.key.isEqual(t) && (e = je(n, e, 0, this.bs));
        // Second, apply all user-provided mutations.
        for (const n of this.mutations) n.key.isEqual(t) && (e = je(n, e, 0, this.bs));
        return e;
    }
    /**
...
/** Decodes a remote document from storage locally to a Document. */ function oi(t, e) {
    if (e.document) return function(t, e, n) {
        const s = Gn(t, e.name), i = Kn(e.updateTime), r = new Ct({
            mapValue: {
                fields: e.fields
            }
        });
    ...
    if (e.noDocument) {
        const t = et._t(e.noDocument.path), n = li(e.noDocument.readTime);
        return new Mt(t, n, {
            hasCommittedMutations: !!e.hasCommittedMutations
        });
    }
    if (e.unknownDocument) {
        const t = et._t(e.unknownDocument.path), n = li(e.unknownDocument.version);
        return new Ft(t, n);
    }
    return C();
}
...
/** Encodes a document for storage locally. */ function ci(t, e, n) {
    const s = ui(n), i = e.key.path.G().tt();
    if (e instanceof kt) {
        const n = function(t, e) {
            return {
                name: jn(t, e.key),
                fields: e.yt().mapValue.fields,
                updateTime: Bn(t, e.version.q())
            };
...
function _i(t, e) {
    const n = (e.baseMutations || []).map((e => ns(t.Os, e)));
    ...
    const s = e.mutations.map((e => ns(t.Os, e))), i = H.fromMillis(e.localWriteTimeMs);
...
/** Decodes a DbTarget into TargetData */ function fi(t) {
    ...
    s = we(ue(Hn(i.documents[0])))) : s = function(t) {
        return we(os(t));
...
/** Encodes TargetData into a DbTarget for storage locally. */ function di(t, e) {
    const n = hi(e.kt), s = hi(e.lastLimboFreeSnapshotVersion);
    let i;
    i = Kt(e.target) ? is(t.Os, e.target) : rs(t.Os, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
        const r = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new Gs(e.targetId, Bt(e.target), n, r, e.sequenceNumber, s, i);
}
 ...
 */
async function yi(t) {
    if (t.code !== O.FAILED_PRECONDITION || t.message !== Ns) throw t;
 ...
 */ class bi {
     ...
     */    li(t, e) {
        ...
        return void 0 !== n ? As.resolve(n.ai) : this._i(t, e);
    }
    /**
...
/** A mutation queue for a specific user, backed by IndexedDB. */ class Di {
    ...
    Ai(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            N("number" == typeof o);
            const c = new si(o, e, n, s), u = function(t, e, n) {
                const s = n.baseMutations.map((e => es(t.Os, e))), i = n.mutations.map((e => es(t.Os, e)));
            ...
            for (const t of s) {
                ...
                h = h.add(t.key.path.G()), a.push(r.put(u)), a.push(i.put(e, Us.PLACEHOLDER));
            }
            return h.forEach((e => {
    ...
    Ri(t, e) {
        return Ni(t).get(e).next((t => t ? (N(t.userId === this.userId), _i(this.Ut, t)) : null));
    }
    /**
    ...
    Vi(t, e) {
        ...
        return Ni(t).us({
            ...
            e.userId === this.userId && (N(e.batchId >= n), i = _i(this.Ut, e)), s.done();
        })).next((() => i));
    }
    gi(t) {
    ...
    pi(t, e) {
        ...
        return xi(t).us({
            ...
            return Ni(t).get(u).next((t => {
                if (!t) throw C();
                N(t.userId === this.userId), i.push(_i(this.Ut, t));
            }));
            r.done();
        })).next((() => i));
    }
    ...
    vi(t, e) {
        ...
        return e.forEach((e => {
            s.push(Ni(t).get(e).next((t => {
                if (null === t) throw C();
                N(t.userId === this.userId), n.push(_i(this.Ut, t));
            })));
        })), As.Fn(s).next((() => n));
    }
    Di(t, e) {
 ...
 */ class Mi {
    ...
    Ui(t) {
        return this.Bi(t).next((t => J.$(new H(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
    }
    Ki(t) {
    ...
    Hi(t, e) {
        return this.Ji(t, e.targetId).next((() => Fi(t).delete(e.targetId))).next((() => this.Bi(t))).next((e => (N(e.targetCount > 0), 
    ...
    Bi(t) {
        return $i(t).get(Hs.key).next((t => (N(null !== t), t)));
    }
    qi(t, e) {
        return $i(t).put(Hs.key, e);
    }
    ji(t, e) {
        return Fi(t).put(di(this.Ut, e));
    }
    /**
    ...
    nr(t, e, n) {
        ...
        return As.forEach(e, (e => {
            const i = Os(e.path);
            return As.Fn([ s.delete([ n, i ]), this.Ei.sr(t, n, e) ]);
        }));
    }
    Ji(t, e) {
    ...
    ir(t, e) {
        ...
        return s.us({
            ...
            const s = Fs(t[1]), r = new et(s);
            i = i.add(r);
        })).next((() => i));
    }
    Oi(t, e) {
        const n = Os(e.path), s = IDBKeyRange.bound([ n ], [ z(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return Li(t).us({
    ...
    // PORTING NOTE: Multi-tab only.
    vn(t, e) {
        return Fi(t).get(e).next((t => t ? fi(t) : null));
    }
}
 ...
 */ class qi {
    constructor(t) {
        this.rr = t, this.buffer = new fn(Bi), this.cr = 0;
    }
    ur() {
        return ++this.cr;
    }
    ...
    dr(t) {
        ...
        b("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this._r = this.ls.Er("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            ...
            try {
                ...
                ys(t) ? b("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await yi(t);
            }
            await this.dr(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Ki {
    ...
    gr(t, e) {
        ...
        As.resolve(Vi)) : this.yr(t).next((n => n < this.params.Gs ? (b("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ` + this.params.Gs), 
        Vi) : this.pr(t, e)));
    }
    yr(t) {
        return this.Ir.yr(t);
...
class Qi {
     ...
     */    Dr(t, e) {
        return function(t, e) {
            let n = !1;
            return Oi(t).hs((s => Ci(t, s, e).next((t => (t && (n = !0), As.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    Vr(t, e) {
        ...
        return this.Sr(t, ((r, o) => {
            if (o <= e) {
                const e = this.Dr(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.li(t, r).next((() => (n.hi(r), Li(t).delete([ 0, Os(r.path) ]))));
                }));
                s.push(e);
            }
        })).next((() => As.Fn(s))).next((() => n.apply(t))).next((() => i));
    }
    removeTarget(t, e) {
        const n = e.Mt(t.ps);
 ...
 */ class ji {
    ...
    li(t, e) {
        return Hi(t).get(Ji(e)).next((t => this.Fr(t)));
    }
    /**
    ...
    Kr(t, e, n) {
        ...
        return Hi(t).us(r, ((t, n, r) => {
            ...
            e.path.X(o.key.path) ? o instanceof kt && Ae(e, o) && (s = s.Gt(o.key, o)) : r.done();
        })).next((() => s));
    }
    Cr(t) {
    ...
    getMetadata(t) {
        return zi(t).get(js.key).next((t => (N(!!t), t)));
    }
    Mr(t, e) {
     ...
     */    Fr(t) {
        if (t) {
            ...
            return e instanceof Mt && e.version.isEqual(J.min()) ? null : e;
        }
        return null;
    }
}
...
class Gi extends bi {
    ...
    di(t) {
        ...
        return this.ii.forEach(((i, r) => {
            ...
            if (r.ai) {
                const c = ci(this.Wr.Ut, r.ai, this.oi(i));
                s = s.add(i.path.G());
                const u = Si(c);
                ...
                const n = ci(this.Wr.Ut, new Mt(i, J.min()), this.oi(i));
                e.push(this.Wr.ci(t, i, n));
            } else e.push(this.Wr.hi(t, i));
        })), s.forEach((n => {
            e.push(this.Wr.wi.Bs(t, n));
        })), e.push(this.Wr.updateMetadata(t, n)), As.Fn(e);
    }
    _i(t, e) {
...
class tr {
    ...
    a) {
        ...
        this.uo = t => Promise.resolve(), !tr.Kn()) throw new k(O.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.Ei = new Qi(this, s), this.ao = e + "main", this.Ut = new ri(c), this.ho = new Ps(this.ao, 11, new Yi(this.Ut)), 
        this.lo = new Mi(this.Ei, this.Ut), this.wi = new Ri, this._o = function(t, e) {
            return new ji(t, e);
        }
        /**
 ...
 */
     ...
     */    start() {
        ...
        return this.Eo().then((() => {
            ...
            throw new k(O.FAILED_PRECONDITION, Zi);
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.ho.runTransaction(t, s, ti, (s => (i = new ei(s, this.no ? this.no.next() : K.k), 
        "readwrite-primary" === e ? this.Vo(i).next((t => !!t || this.po(i))).next((e => {
            ...
            this.Xr.yo((() => this.uo(!1))), new k(O.FAILED_PRECONDITION, Ns);
            return n(i);
    ...
    Wo(t) {
        return er(t).get(Ls.key).next((t => {
            if (null !== t && this.No(t.leaseTimestampMs, 5e3) && !this.ko(t.ownerId) && !this.So(t) && !(this.eo || this.allowTabSynchronization && t.allowTabSynchronization)) throw new k(O.FAILED_PRECONDITION, Zi);
        }));
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    bo(t) {
        const e = er(t);
        return e.get(Ls.key).next((t => this.So(t) ? (b("IndexedDbPersistence", "Releasing primary lease."), 
 ...
 */
        return function(t) {
            return et.lt(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Xo(t, e.path) : fe(e) ? this.Zo(t, e, n) : this.tc(t, e, n);
    }
    Xo(t, e) {
        // Just do a simple document lookup.
        return this.Go(t, new et(e)).next((t => {
            let e = mn();
            return t instanceof kt && (e = e.Gt(t.key, t)), e;
        }));
    }
    Zo(t, e, n) {
 ...
 */ (e, r.child(s));
    ...
    tc(t, e, n) {
        ...
        this.ec(t, i, s).next((t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                const n = e.key, i = s.get(n), r = je(e, i, 0, t.bs);
                s = r instanceof kt ? s.Gt(n, r) : s.remove(n);
            }
        }))))).next((() => (
    ...
    ec(t, e, n) {
        ...
        return this._o.getEntries(t, s).next((t => (t.forEach(((t, e) => {
            null !== e && e instanceof kt && (i = i.Gt(t, e));
        })), i)));
    }
}
 ...
 */ class or {
    ...
    /** Returns all local documents matching the specified query. */    Kr(t, e, n, s) {
        ...
        }(e) || n.isEqual(J.min()) ? this.cc(t, e) : this.oc.Jo(t, s).next((i => {
            const r = this.uc(e, i);
            return (ae(e) || he(e)) && this.ac(e.limitType, r, s, n) ? this.cc(t, e) : (y() <= o.DEBUG && b("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), me(e)), 
    ...
    /** Applies the query filter and sorting to the provided documents.  */    uc(t, e) {
        ...
        let n = new fn(Re(t));
        return e.forEach(((e, s) => {
            s instanceof kt && Ae(t, s) && (n = n.add(s));
        })), n;
    }
    /**
...
class cr {
    ...
    t, e, n, s) {
        ...
        this._c = new pi((t => Bt(t)), Ut), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.fc = J.min(), this.jo = t.Uo(n), this.dc = t.Nr(), this.lo = t.vr(), this.wc = new ir(this.dc, this.jo, this.persistence.Ko()), 
...
async function ar(t, e) {
    ...
    const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
        ...
        // MutationQueue.
        i = new ir(n.dc, s, n.persistence.Ko()), s.yi(t)))).next((e => {
            const n = [], s = [];
 ...
 */
        ...
        i) {
            ...
            return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
                ...
                return n.forEach(((n, o) => {
                    ...
                    // cache.
                    o instanceof Mt && o.version.isEqual(J.min()) ? (
        ...
        return As.Fn(o).next((() => r.apply(t))).next((() => n.wc.Yo(t, c)));
    })).then((t => (n.lc = i, t)));
}
...
function dr(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, As.resolve(s)) : n.lo.Li(t).next((i => (s = new Ve(e, i, 0 /* Listen */ , t.ps), 
        n.lo.Wi(t, s).next((() => s)))))));
    })).then((t => {
...
async function wr(t, e, n) {
    const s = x(t), i = s.lc.get(e), r = n ? "readwrite" : "readwrite-primary";
    try {
 ...
 */ function Er(t, e, n) {
    ...
    return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
        const s = x(t), i = s._c.get(n);
        return void 0 !== i ? As.resolve(s.lc.get(i)) : s.lo.Zi(e, n);
    }(s, t, we(e)).next((e => {
        if (e) return i = e.lastLimboFreeSnapshotVersion, s.lo.ir(t, e.targetId).next((t => {
            r = t;
        }));
    })).next((() => s.hc.Kr(t, e, n ? i : J.min(), n ? r : Pn()))).next((t => ({
        documents: t,
        mc: r
    })))));
}
...
// PORTING NOTE: Multi-Tab only.
function Tr(t, e) {
    const n = x(t), s = x(n.lo), i = n.lc.get(e);
 ...
 */ class Ar {
    ...
    ks(t, e) {
        return As.resolve(this.Rc.get(e));
    }
    Ms(t, e) {
    ...
    Fs(t, e) {
        return As.resolve(this.Pc.get(e));
    }
    $s(t, e) {
        var n;
        return this.Pc.set(e.name, {
            name: (n = e).name,
            query: wi(n.bundledQuery),
            readTime: Kn(n.readTime)
        }), As.resolve();
    }
}
 ...
 */ class Rr {
    constructor() {
        ...
        this.Vc = new fn(Pr.gc), 
        // A set of outstanding references to a document sorted by target id.
        this.yc = new fn(Pr.bc);
    }
    ...
    Oi(t) {
        const e = new Pr(t, 0), n = this.Vc.Ae(e);
...
class Pr {
    ...
    /** Compare by key then by ID */    static gc(t, e) {
        return et.K(t.key, e.key) || j(t.Oc, e.Oc);
    }
    /** Compare by ID then by key */    static bc(t, e) {
        return j(t.Oc, e.Oc) || et.K(t.key, e.key);
    }
}
 ...
 */ class Vr {
    constructor(t, e) {
        ...
        this.Mc = new fn(Pr.gc);
    }
    mi(t) {
        return As.resolve(0 === this.jo.length);
    }
    Ai(t, e, n, s) {
        const i = this.kc;
        ...
        for (const e of s) this.Mc = this.Mc.add(new Pr(e.key, i)), this.wi.Bs(t, e.key.path.G());
        return As.resolve(r);
    }
    Ri(t, e) {
        return As.resolve(this.Fc(e));
    }
    Vi(t, e) {
        const n = e + 1, s = this.$c(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return As.resolve(this.jo.length > i ? this.jo[i] : null);
    }
    gi() {
        return As.resolve(0 === this.jo.length ? -1 : this.kc - 1);
    }
    yi(t) {
        return As.resolve(this.jo.slice());
    }
    pi(t, e) {
    ...
    Di(t, e) {
        N(0 === this.Bc(e.batchId, "removed")), this.jo.shift();
        let n = this.Mc;
    ...
    Oi(t, e) {
        const n = new Pr(e, 0), s = this.Mc.Ae(n);
        return As.resolve(e.isEqual(s && s.key));
    }
    xi(t) {
        return this.jo.length, As.resolve();
    }
    /**
...
class gr {
    ...
    Kr(t, e, n) {
        ...
        for (;r.oe(); ) {
            ...
            o.L(n) <= 0 || i instanceof kt && Ae(e, i) && (s = s.Gt(i.key, i));
        }
        return As.resolve(s);
    }
    Uc(t, e) {
 ...
 */ class pr {
    constructor(t) {
         ...
         * IDs.
         */
        this.Wc = new Rr, this.targetCount = 0, this.jc = ki.Fi();
    }
    Tn(t, e) {
        return this.Kc.forEach(((t, n) => e(n))), As.resolve();
    }
    Ui(t) {
        return As.resolve(this.lastRemoteSnapshotVersion);
    }
    Ki(t) {
        return As.resolve(this.Qc);
    }
    Li(t) {
        return this.highestTargetId = this.jc.next(), As.resolve(this.highestTargetId);
    }
    Qi(t, e, n) {
    ...
    ji(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.jc = new ki(e), this.highestTargetId = e), t.sequenceNumber > this.Qc && (this.Qc = t.sequenceNumber);
    }
    Wi(t, e) {
    ...
    tr(t, e, n) {
        return this.Wc.vc(e, n), As.resolve();
    }
    nr(t, e, n) {
        this.Wc.Dc(e, n);
    ...
    Ji(t, e) {
        return this.Wc.Cc(e), As.resolve();
    }
    ir(t, e) {
    ...
    Oi(t, e) {
        return As.resolve(this.Wc.Oi(e));
    }
}
...
class br {
     ...
     */
    constructor(t, e) {
        this.Gc = {}, this.no = new K(0), this.so = !1, this.so = !0, this.Ei = t(this), 
        this.lo = new pr(this);
        this.wi = new mi, this._o = function(t, e) {
            return new gr(t, e);
        }(this.wi, (t => this.Ei.zc(t))), this.Ut = new ri(e), this.fo = new Ar(this.Ut);
    }
    start() {
    ...
    Uo(t) {
        let e = this.Gc[t.i()];
        return e || (e = new Vr(this.wi, this.Ei), this.Gc[t.i()] = e), e;
    }
    vr() {
        return this.lo;
    }
    ...
    runTransaction(t, e, n) {
        ...
        const s = new vr(this.no.next());
        return this.Ei.Hc(), n(s).next((t => this.Ei.Jc(s).next((() => t)))).kn().then((t => (s.gs(), 
        t)));
    }
    Yc(t, e) {
        return As.$n(Object.values(this.Gc).map((n => () => n.Oi(t, e))));
    }
}
...
class Sr {
    ...
    er(t, e, n) {
        return this.Xc.er(n, e), this.eu.delete(n.toString()), As.resolve();
    }
    sr(t, e, n) {
        return this.Xc.sr(n, e), this.eu.add(n.toString()), As.resolve();
    }
    Ni(t, e) {
        return this.eu.add(e.toString()), As.resolve();
    }
    removeTarget(t, e) {
    ...
    nu(t, e) {
        return As.$n([ () => As.resolve(this.Xc.Oi(e)), () => this.persistence.vr().Oi(t, e), () => this.persistence.Yc(t, e) ]);
    }
}
...
class xr {
     ...
     */    static su(t, e, n) {
        ...
        i && (r = new k(s.error.code, s.error.message))), i ? new xr(t, e, s.state, r) : (v("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    iu() {
        const t = {
...
class Or {
     ...
     */    static su(t, e) {
        ...
        s && (i = new k(n.error.code, n.error.message))), s ? new Or(t, n.state, i) : (v("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    iu() {
        const t = {
 ...
 */ class kr {
     ...
     */    static su(t, e) {
        ...
        return s ? new kr(t, i) : (v("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Mr {
     ...
     */    static su(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Mr(e.clientId, e.onlineState) : (v("SharedClientState", "Failed to parse online state: " + t), 
        null);
    }
}
 ...
 */ class $r {
    constructor(t, e, n, s, i) {
        ...
        this.au = null, this.D = null, this.hu = this.lu.bind(this), this._u = new hn(j), 
        this.wr = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.du = Dr(this.persistenceKey, this.cu), 
        this.wu = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this._u = this._u.Gt(this.cu, new Fr), this.Eu = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    lu(t) {
        ...
        if (e.storageArea === this.storage) {
            if (b("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.du) return void v("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Xr.yo((async () => {
                if (this.wr) {
 ...
 */ (e.newValue);
    ...
    vu(t, e, n) {
        const s = new xr(this.currentUser, t, e, n), i = Cr(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.iu());
    }
    Du(t) {
...
class Lr {
    constructor() {
        this.ta = new Fr, this.ea = {}, this.au = null, this.D = null;
    }
    bu(t) {
        // No op.
    }
    ...
    start() {
        return this.ta = new Fr, Promise.resolve();
    }
    $u(t, e, n) {
        // No op.
    }
...
class {
    ...
    Pa(t, e, n, s) {
        ...
        const r = {};
        return this.ga(r, s), this.ya(t, i, r, n).then((t => (b("RestConnection", "Received: ", t), 
        t)), (e => {
            ...
            o.listenOnce(E.COMPLETE, (() => {
                try {
                    switch (o.getLastErrorCode()) {
                      ...
                      case T.TIMEOUT:
                        b("Connection", 'RPC "' + t + '" timed out'), r(new k(O.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case T.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (t && t.status && t.message) {
                                ...
                                r(new k(e, t.message));
                            } else r(new k(O.UNKNOWN, "Server responded with status " + o.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        r(new k(O.UNAVAILABLE, "Connection failed."));
                        break;
    ...
    ba(t, e) {
        const n = [ this.Aa, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], s = I(), i = m(), r = {
        ...
        a() || h() || l() || _() || f() || d() || (r.httpHeadersOverwriteParam = "$httpHeaders");
        const o = n.join("");
        ...
        // on a closed stream
                const E = new Kr({
            aa: t => {
                w ? b("Connection", "Not sending because WebChannel is closed:", t) : (u || (b("Connection", "Opening WebChannel transport."), 
                c.open(), u = !0), b("Connection", "WebChannel sending:", t), c.send(t));
            },
            ha: () => c.close()
        }), T = (t, e, n) => {
        ...
        // enough the code is exception free.
            ...
            w || (w = !0, b("Connection", "WebChannel transport closed"), E.Ta());
        })), T(c, A.EventType.ERROR, (t => {
            w || (w = !0, S("Connection", "WebChannel transport errored:", t), E.Ta(new k(O.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    function(t) {
                        ...
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                        const e = on[t];
                        if (void 0 !== e) return an(e);
                    }(t), n = i.message;
                    void 0 === e && (e = O.INTERNAL, n = "Unknown error status: " + t + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    w = !0, E.Ta(new k(e, n)), c.close();
                } else b("Connection", "WebChannel received:", n), E.Ia(n);
            }
        })), T(i, R.STAT_EVENT, (t => {
...
class zr {
     ...
     */    ka(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && b("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.Ca} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
...
class Hr {
    constructor(t, e, n, s, i, r) {
         ...
         * close.
         */
        this.qa = 0, this.Ua = null, this.stream = null, this.Ka = new zr(t, e);
    }
    /**
    ...
    auth() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            t((() => {
                const t = new k(O.UNKNOWN, "Fetching auth token failed: " + e.message);
                return this.eh(t);
            }));
        }));
    }
     ...
     */    Za(t) {
        return e => {
            this.Xr.Rs((() => this.qa === t ? e() : (b("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
 ...
 */ class Jr extends Hr {
    ...
    onMessage(t) {
        ...
        const e = ts(this.Ut, t), n = function(t) {
            ...
            return e.targetIds && e.targetIds.length ? J.min() : e.readTime ? Kn(e.readTime) : J.min();
        }(t);
     ...
     */    ih(t) {
        const e = {};
        e.database = Jn(this.Ut), e.addTarget = function(t, e) {
            let n;
            const s = e.target;
            return n = Kt(s) ? {
                documents: is(t, s)
                ...
                query: rs(t, s)
            }, n.targetId = e.targetId, e.resumeToken.wt() > 0 ? n.resumeToken = qn(t, e.resumeToken) : e.kt.L(J.min()) > 0 && (
            // TODO(wuandy): Consider removing above check because it is most likely true.
            // Right now, many tests depend on this behaviour though (leaving min() out
            // of serialization).
            n.readTime = Bn(t, e.kt.q())), n;
        }(this.Ut, t);
     ...
     */    rh(t) {
        const e = {};
        e.database = Jn(this.Ut), e.removeTarget = t, this.Ja(e);
    }
}
 ...
 */ class Yr extends Hr {
    ...
    onMessage(t) {
        ...
        N(!!t.streamToken), this.lastStreamToken = t.streamToken, this.oh) {
            // A successful first write response means the stream is healthy,
            // Note, that we could consider a successful handshake healthy, however,
            // the write itself might be causing an error we want to back off from.
            this.Ka.reset();
            const e = ss(t.writeResults, t.commitTime), n = Kn(t.commitTime);
            return this.listener.hh(n, e);
        }
        // The first response is always the handshake response
        return N(!t.writeResults || 0 === t.writeResults.length), this.oh = !0, this.listener.lh();
    }
    /**
     ...
     */    _h() {
        ...
        const t = {};
        t.database = Jn(this.Ut), this.Ja(t);
    }
...
class Xr extends class {} {
    ...
    dh() {
        if (this.fh) throw new k(O.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Gets an auth token and invokes the provided RPC. */    Pa(t, e, n) {
        return this.dh(), this.credentials.getToken().then((s => this.La.Pa(t, e, n, s))).catch((t => {
            throw t.code === O.UNAUTHENTICATED && this.credentials._(), t;
        }));
    }
...
class Zr {
    ...
    Ah(t) {
        ...
        this.Th ? (v(e), this.Th = !1) : b("OnlineStateTracker", e);
    }
    Ph() {
    ...
    e, n, s, i) {
        ...
        this.Dh = [], this.Ch = i, this.Ch.na((t => {
            n.Rs((async () => {
                ...
                // down our streams.
                ao(this) && (b("RemoteStore", "Restarting streams for network reachability change."), 
                await async function(t) {
                    const e = x(t);
                    e.Sh.add(4 /* ConnectivityChange */), await no(e), e.Nh.set("Unknown" /* Unknown */), 
                    e.Sh.delete(4 /* ConnectivityChange */), await eo(e);
                }(this));
            }));
        })), this.Nh = new Zr(n, s);
    }
...
async function eo(t) {
    if (ao(t)) for (const e of t.Dh) await e(/* enabled= */ !0);
}
 ...
 */ function io(t, e) {
    const n = x(t), s = bo(n);
    n.bh.delete(e), s.Wa() && oo(n, e), 0 === n.bh.size && (s.Wa() ? s.za() : ao(n) && 
 ...
 */ function uo(t) {
    return ao(t) && !bo(t).Qa() && t.bh.size > 0;
}

function ao(t) {
    return 0 === x(t).Sh.size;
}
...
async function fo(t, e, n) {
    ...
    t.Nh.set("Online" /* Online */), e instanceof Nn && 2 /* Removed */ === e.state && e.cause) 
 ...
 */ (t, e);
        ...
        await wo(t, n);
    } else if (e instanceof Dn ? t.xh.fn(e) : e instanceof Cn ? t.xh.Rn(e) : t.xh.En(e), 
    !n.isEqual(J.min())) try {
        const e = await lr(t.Vh);
        n.L(e) >= 0 && 
 ...
 */
        ...
        b("RemoteStore", "Failed to raise snapshot:", e), await wo(t, e);
    }
}
 ...
 */ async function wo(t, e, n) {
    ...
    await no(t), t.Nh.set("Offline" /* Offline */), n || (
    ...
    t.ls.yo((async () => {
        b("RemoteStore", "Retrying IndexedDB access"), await n(), t.Sh.delete(1 /* IndexedDbFailed */), 
        await eo(t);
    }));
}
...
function Ao(t) {
    return ao(t) && !vo(t).Qa() && t.ph.length > 0;
}
...
async function go(t, e, n) {
    const s = t.ph.shift(), i = ii.from(s, e, n);
    await Eo(t, (() => t.yh.Mh(i))), 
...
async function yo(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, un(n) && n !== O.ABORTED) {
            ...
            // restart.
                        vo(t).Ga(), await Eo(t, (() => t.yh.Fh(n.batchId, e))), 
...
async function po(t, e) {
    const n = x(t);
    e ? (n.Sh.delete(2 /* IsSecondary */), await eo(n)) : e || (n.Sh.add(2 /* IsSecondary */), 
    await no(n), n.Nh.set("Unknown" /* Unknown */));
}
 ...
 */ function bo(t) {
    ...
    t.$h = function(t, e, n) {
        const s = x(t);
        return s.dh(), new Jr(e, s.La, s.credentials, s.Ut, n);
    }
    /**
 * @license
 * Copyright 2018 Google LLC
 ...
 */ (t.gh, t.ls, {
        ...
        e ? (t.$h.Ga(), uo(t) ? co(t) : t.Nh.set("Unknown" /* Unknown */)) : (await t.$h.stop(), 
        ho(t));
    }))), t.$h;
}
 ...
 */ function vo(t) {
    ...
    t.Lh = function(t, e, n) {
        const s = x(t);
        return s.dh(), new Yr(e, s.La, s.credentials, s.Ut, n);
    }(t.gh, t.ls, {
        la: Po.bind(null, t),
        fa: yo.bind(null, t),
        lh: Vo.bind(null, t),
        ...
        await To(t)) : (await t.Lh.stop(), t.ph.length > 0 && (b("RemoteStore", `Stopping write stream with ${t.ph.length} pending writes`), 
        t.ph = []));
    }))), t.Lh;
}
...
class Do {
    constructor() {
        this.queries = new pi((t => Ie(t)), Te), this.onlineState = "Unknown" /* Unknown */ , 
        this.qh = new Set;
    }
}
...
async function Co(t, e) {
    ...
    if (r || (i = !0, r = new So), i) try {
        ...
        const n = Cs(t, `Initialization of query '${me(e.query)}' failed`);
 ...
 */ class Mo {
     ...
     */    Qh(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new bn(t.query, t.docs, t.ve, e, t.Se, t.fromCache, t.De, 
    ...
    Yh(t) {
        t = bn.Ne(t.query, t.docs, t.Se, t.fromCache), this.Gh = !0, this.jh.next(t);
    }
}
 ...
 */ class Lo {
    ...
    e) {
        ...
        this.Se = Pn(), this.nl = Re(t), this.sl = new yn(this.nl);
    }
    /**
     ...
     */    rl(t, e) {
        const n = e ? e.ol : new pn, s = e ? e.sl : this.sl;
        ...
        const c = ae(this.query) && s.size === this.query.limit ? s.last() : null, u = he(this.query) && s.size === this.query.limit ? s.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.Yt(((t, e) => {
            const a = s.get(t);
            let h = e instanceof kt ? e : null;
        ...
        })), ae(this.query) || he(this.query)) for (;r.size > this.query.limit; ) {
            const t = ae(this.query) ? r.last() : r.first();
 ...
 */ (t.type, e.type) || this.nl(t.doc, e.doc))), this.ul(n);
        ...
        if (this.tl = o, 0 !== i.length || c) {
            return {
                snapshot: new bn(this.query, t.sl, s, i, t.Se, 0 /* Local */ === o, c, 
                /* excludesMetadataChanges= */ !1),
                hl: r
            };
        }
    ...
    al() {
        ...
        // updating many documents.
                const t = this.el;
        this.el = Pn(), this.sl.forEach((t => {
            this.ll(t.key) && (this.el = this.el.add(t.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach((t => {
            this.el.has(t) || e.push(new $o(t));
        })), this.el.forEach((n => {
    ...
    // PORTING NOTE: Multi-tab only.
    fl() {
        return bn.Ne(this.query, this.sl, this.Se, 0 /* Local */ === this.tl);
    }
}
...
/** Tracks a limbo resolution. */ class qo {
    constructor(t) {
        this.key = t, 
        /**
 ...
 */ class Uo {
    ...
    s, i, r) {
        ...
        this.ml = {}, this.Al = new pi((t => Ie(t)), Te), this.Rl = new Map, 
        /**
         ...
         */
        this.gl = new Map, this.yl = new Rr, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.pl = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.bl = new Map, this.vl = ki.$i(), this.onlineState = "Unknown" /* Unknown */ , 
...
async function Ko(t, e) {
    ...
    s = r.targetId, n.Tl.Cu(s), i = r.view.fl(); else {
        const t = await dr(n.Vh, we(e)), r = n.Tl.Cu(t.targetId);
        s = t.targetId, i = await Qo(n, e, s, "current" === r), n.Dl && so(n.wl, t);
    }
    return i;
}
 ...
 */ async function Qo(t, e, n, s) {
    ...
    t.Cl = (e, n, s) => async function(t, e, n, s) {
        ...
        return sc(t, e.targetId, o.hl), o.snapshot;
    }(t, e, n, s);
    const i = await Er(t.Vh, e, 
    /* usePreviousResults= */ !0), r = new Lo(e, i.mc), o = r.rl(i.documents), c = Sn.$e(n, s && "Offline" /* Offline */ !== t.onlineState), u = r.di(o, 
...
/** Stops listening to the query. */ async function Wo(t, e) {
    const n = x(t), s = n.Al.get(e), i = n.Rl.get(s.targetId);
    if (i.length > 1) return n.Rl.set(s.targetId, i.filter((t => !Te(t, e)))), void n.Al.delete(e);
    // No other queries are mapped to the target, clean up the query and the target.
        if (n.Dl) {
        // We need to remove the local query target first to allow us to verify
        // whether any other client is still interested in this target.
        n.Tl.xu(s.targetId);
        n.Tl.pu(s.targetId) || await wr(n.Vh, s.targetId, 
        /*keepPersistedTargetData=*/ !1).then((() => {
            n.Tl.ku(s.targetId), io(n.wl, s.targetId), ec(n, s.targetId);
        })).catch(yi);
    } else ec(n, s.targetId), await wr(n.Vh, s.targetId, 
 ...
 */ async function jo(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = x(t), s = H.now(), i = e.reduce(((t, e) => t.add(e.key)), Pn());
            let r;
 ...
 * it.
 */ (s, t.batchId, n), await oc(s, t.ii), await To(s.wl);
    } catch (t) {
 ...
 */ async function Go(t, e) {
    ...
    try {
        ...
        // Update `receivedDocument` as appropriate for any limbo targets.
            ...
            N(t.Be.size + t.qe.size + t.Ue.size <= 1), t.Be.size > 0 ? s.dl = !0 : t.qe.size > 0 ? N(s.dl) : t.Ue.size > 0 && (N(s.dl), 
            s.dl = !1));
        })), await oc(n, t, e);
    } catch (t) {
        await yi(t);
 ...
 */ async function Ho(t, e, n) {
    ...
    if (r) {
        ...
        let t = new hn(et.K);
        t = t.Gt(r, new Mt(r, J.min()));
        const n = Pn().add(r), i = new vn(J.min(), 
        ...
        s.Vl = s.Vl.remove(r), s.gl.delete(e), rc(s);
    } else await wr(s.Vh, e, 
    /* keepPersistedTargetData */ !1).then((() => ec(s, e, n))).catch(yi);
}
...
async function Jo(t, e) {
    ...
    try {
        ...
        // before listen events.
                tc(n, s, /*error=*/ null), Zo(n, s), n.Tl.Su(s, "acknowledged"), await oc(n, t);
    } catch (t) {
        await yi(t);
    }
}
    ...
    try {
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t => {
                let s;
                return n.jo.Ri(t, e).next((e => (N(null !== e), s = e.keys(), n.jo.Di(t, e)))).next((() => n.jo.xi(t))).next((() => n.wc.Jo(t, s)));
            }));
        }
        /**
 ...
 */ (s.Vh, e);
        ...
        // listen events.
                tc(s, e, n), Zo(s, e), s.Tl.Su(e, "rejected", n), await oc(s, t);
    } catch (n) {
        await yi(n);
    }
}
 ...
 */ async function Xo(t, e) {
    const n = x(t);
    ao(n.wl) || b("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
...
function nc(t, e) {
    ...
    const n = t.Vl.get(e);
    null !== n && (io(t.wl, n), t.Vl = t.Vl.remove(e), t.gl.delete(n), rc(t));
}

function sc(t, e, n) {
    for (const s of n) if (s instanceof Fo) t.yl.er(s.key, e), ic(t, s); else if (s instanceof $o) {
        b("SyncEngine", "Document no longer in limbo: " + s.key), t.yl.sr(s.key, e);
        t.yl.Oi(s.key) || 
        // We removed the last reference for this key
        nc(t, s.key);
    } else C();
...
function ic(t, e) {
    const n = e.key;
    t.Vl.get(n) || (b("SyncEngine", "New document in limbo: " + n), t.Pl.push(n), rc(t));
}
 ...
 */ function rc(t) {
    for (;t.Pl.length > 0 && t.Vl.size < t.Il; ) {
        ...
        t.gl.set(n, new qo(e)), t.Vl = t.Vl.Gt(e, n), so(t.wl, new Ve(we(ue(e.path)), n, 2 /* LimboResolution */ , K.k));
    }
}
...
async function oc(t, e, n) {
    ...
    s.Al.Y() || (s.Al.forEach(((t, c) => {
        ...
        const n = x(t);
        try {
            await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t => As.forEach(e, (e => As.forEach(e.nc, (s => n.persistence.Ei.er(t, e.targetId, s))).next((() => As.forEach(e.sc, (s => n.persistence.Ei.sr(t, e.targetId, s)))))))));
        } catch (t) {
            if (!ys(t)) throw t;
...
async function cc(t, e) {
    ...
    if (!n.currentUser.isEqual(e)) {
        ...
        const t = await ar(n.Vh, e);
        n.currentUser = e, 
        // Fails tasks waiting for pending writes requested by previous user.
        function(t, e) {
            t.bl.forEach((t => {
                t.forEach((t => {
                    t.reject(new k(O.CANCELLED, e));
                }));
            })), t.bl.clear();
        }(n, "'waitForPendingWrites' promise is rejected due to a user change."), 
        // TODO(b/114226417): Consider calling this only in the primary tab.
        n.Tl.$u(e, t.Tc, t.Ic), await oc(n, t.Ec);
    }
}

function uc(t, e) {
    const n = x(t), s = n.gl.get(e);
    if (s && s.dl) return Pn().add(s.key);
    {
        let t = Pn();
        const s = n.Rl.get(e);
        if (!s) return t;
 ...
 */ async function ac(t, e) {
    const n = x(t), s = await Er(n.Vh, e.query, 
    /* usePreviousResults= */ !0), i = e.view._l(s);
    return n.Dl && sc(n, e.targetId, i.hl), i;
}
...
async function lc(t, e, n, s) {
    const i = x(t), r = await function(t, e) {
        const n = x(t), s = x(n.jo);
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.Pi(t, e).next((e => e ? n.wc.Jo(t, e) : As.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.Vh, e);
    null !== r ? ("pending" === n ? 
    ...
    await To(i.wl) : "acknowledged" === n || "rejected" === n ? (
...
async function _c(t, e) {
    ...
    if (Ic(n), mc(n), !0 === e && !0 !== n.Sl) {
        ...
        const t = n.Tl.gu(), e = await fc(n, t.tt());
        n.Sl = !0, await po(n.wl, !0);
        for (const t of e) so(n.wl, t);
    } else if (!1 === e && !1 !== n.Sl) {
        const t = [];
        let e = Promise.resolve();
        n.Rl.forEach(((s, i) => {
            n.Tl.Ou(i) ? t.push(i) : e = e.then((() => (ec(n, i), wr(n.Vh, i, 
            /*keepPersistedTargetData=*/ !0)))), io(n.wl, i);
        })), await e, await fc(n, t), 
        // PORTING NOTE: Multi-Tab only.
        function(t) {
            const e = x(t);
            e.gl.forEach(((t, n) => {
                io(e.wl, n);
            })), e.yl.Nc(), e.gl = new Map, e.Vl = new hn(et.K);
        }
        /**
...
async function fc(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await dr(s.Vh, we(n[0]));
            for (const t of n) {
                const e = s.Al.get(t), n = await ac(s, e);
                n.snapshot && r.push(n.snapshot);
            }
        } else {
            // For queries that never executed on this client, we need to
            // allocate the target in LocalStore and initialize a new View.
            const n = await Tr(s.Vh, t);
            e = await dr(s.Vh, n), await Qo(s, dc(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
function wc(t) {
    const e = x(t);
    return x(x(e.Vh).persistence).qo();
}
...
async function Ec(t, e, n, s) {
    ...
    b("SyncEngine", "Ignoring unexpected query state notification."); else if (i.Rl.has(e)) switch (n) {
      case "current":
      case "not-current":
        {
            const t = await Ir(i.Vh), s = vn.Fe(e, "current" === n);
            await oc(i, t, s);
            break;
        }
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Tc(t, e, n) {
    ...
    if (s.Sl) {
        for (const t of e) {
            ...
            const e = await Tr(s.Vh, t), n = await dr(s.Vh, e);
            await Qo(s, dc(e), n.targetId, 
            /*current=*/ !1), so(s.wl, n);
        }
        for (const t of n) 
...
function Ic(t) {
    const e = x(t);
    return e.wl.yh.kh = Go.bind(null, e), e.wl.yh.bn = uc.bind(null, e), e.wl.yh.Oh = Ho.bind(null, e), 
    e.ml.sh = xo.bind(null, e.El), e.ml.Nl = Oo.bind(null, e.El), e;
}

function mc(t) {
    const e = x(t);
    return e.wl.yh.Mh = Jo.bind(null, e), e.wl.yh.Fh = Yo.bind(null, e), e;
}
 ...
 */ class Ac {
    ...
    async initialize(t) {
        this.Ut = Gr(t.ma.p), this.Tl = this.xl(t), this.persistence = this.Ol(t), await this.persistence.start(), 
    ...
    Fl(t) {
        return ur(this.persistence, new or, t.$l, this.Ut);
    }
    Ol(t) {
        return new br(Sr.tu, this.Ut);
    }
    xl(t) {
        return new Lr;
    }
 ...
 */ class Rc extends Ac {
    ...
    async initialize(t) {
        await super.initialize(t), await mr(this.Vh), await this.Ll.initialize(this, t), 
        // Enqueue writes from a previous session
        await mc(this.Ll.uu), await To(this.Ll.wl);
    }
    Fl(t) {
        return ur(this.persistence, new or, t.$l, this.Ut);
    }
    ...
    Ol(t) {
        const e = sr(t.ma.p, t.ma.persistenceKey), n = void 0 !== this.cacheSizeBytes ? gi.Js(this.cacheSizeBytes) : gi.Zs;
        return new tr(this.synchronizeTabs, e, t.clientId, n, t.ls, Wr(), jr(), this.Ut, this.Tl, !!this.forceOwnership);
    }
    xl(t) {
        return new Lr;
    }
 ...
 */ class Pc extends Rc {
    ...
    async initialize(t) {
        ...
        const e = this.Ll.uu;
        this.Tl instanceof $r && (this.Tl.uu = {
            Yu: lc.bind(null, e),
            Xu: Ec.bind(null, e),
            Zu: Tc.bind(null, e),
            qo: wc.bind(null, e),
        ...
        await this.persistence.Ao((async t => {
            await _c(this.Ll.uu, t), this.kl && (t && !this.kl.wr ? this.kl.start(this.Vh) : t || this.kl.stop());
        }));
    }
    xl(t) {
        const e = Wr();
        if (!$r.Kn(e)) throw new k(O.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        const n = sr(t.ma.p, t.ma.persistenceKey);
        return new $r(e, t.ls, n, t.clientId, t.$l);
    }
}
 ...
 */ class Vc {
    async initialize(t, e) {
        ...
        /* startAsPrimary=*/ !t.synchronizeTabs), this.Tl.au = t => zo(this.uu, t, 1 /* SharedClientState */), 
        this.wl.yh.Ql = cc.bind(null, this.uu), await po(this.wl, this.uu.Dl));
    }
    Ul(t) {
        return new Do;
    }
    Bl(t) {
        const e = Gr(t.ma.p), n = (s = t.ma, new Qr(s));
        var s;
    ...
    ql(t) {
        return e = this.Vh, n = this.gh, s = t.ls, i = t => zo(this.uu, t, 0 /* RemoteStore */), 
        r = qr.Kn() ? new qr : new Br, new to(e, n, s, i, r);
        var e, n, s, i, r;
    ...
    terminate() {
        return async function(t) {
            const e = x(t);
            b("RemoteStore", "RemoteStore shutting down."), e.Sh.add(5 /* Shutdown */), await no(e), 
            e.Ch.Mo(), 
 ...
 */ class yc {
     ...
     */    static fromBase64String(t) {
        try {
            return new yc(ct.fromBase64String(t));
        } catch (t) {
            throw new k(O.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + t);
        }
    }
    /**
     ...
     */    static fromUint8Array(t) {
        return new yc(ct.fromUint8Array(t));
    }
    /**
 ...
 */ class pc {
     ...
     */
    constructor(...t) {
        for (let e = 0; e < t.length; ++e) if (0 === t[e].length) throw new k(O.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.zl = new tt(t);
    }
    /**
 ...
 * limitations under the License.
 */ function Dc(t, e, n) {
    if (!n) throw new k(O.INVALID_ARGUMENT, `Function ${t}() cannot be called with an empty ${e}.`);
}
 ...
 */
function Cc(t) {
    if (!et.lt(t)) throw new k(O.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function Nc(t) {
    if (et.lt(t)) throw new k(O.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
...
e) {
    ...
    t = t.Hl), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new k(O.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        {
            const n = xc(t);
            throw new k(O.INVALID_ARGUMENT, `Expected type '${e.name}', but it was: ${n}`);
        }
    }
    return t;
}
...
function kc(t, e) {
    if (e <= 0) throw new k(O.INVALID_ARGUMENT, `Function ${t}() requires a positive number, but it was: ${e}.`);
}
...
class Mc {
    constructor(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new k(O.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = true;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new k(O.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
        function(t, e, n, s) {
            if (!0 === e && !0 === s) throw new k(O.INVALID_ARGUMENT, `${t} and ${n} cannot be used together.`);
...
class $c {
    /** @hideconstructor */
    constructor(t, e) {
        this.Jl = "(lite)", this.Yl = new Mc({}), this.Xl = !1, t instanceof U ? (this.Zl = t, 
        this.t_ = new F) : (this.e_ = t, this.Zl = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new k(O.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 */ (t), this.t_ = new $(e));
     ...
     * instance.
     */    get app() {
        if (!this.e_) throw new k(O.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.e_;
    }
    get n_() {
        return this.Xl;
    ...
    r_(t) {
        if (this.Xl) throw new k(O.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this.Yl = new Mc(t), void 0 !== t.credentials && (this.t_ = function(t) {
            if (!t) return new F;
            switch (t.type) {
              case "gapi":
                const e = t.client;
              ...
              default:
                throw new k(O.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
    }
    o_() {
 ...
 */
        return function(t) {
            const e = Fc.get(t);
            e && (b("ComponentProvider", "Removing Datastore"), Fc.delete(t), e.terminate());
 ...
 */ class Bc {
     ...
     */    get parent() {
        return new Uc(this.firestore, this.a_, this.h_.path.G());
    }
    /**
     ...
     */    withConverter(t) {
        return new Bc(this.firestore, t, this.h_);
    }
}
 ...
 */ class qc {
     ...
     */    withConverter(t) {
        return new qc(this.firestore, t, this.__);
    }
}
 ...
 */ class Uc extends qc {
    /** @hideconstructor */
    constructor(t, e, n) {
        super(t, e, ue(n)), this.firestore = t, this.l_ = n, this.type = "collection";
    }
     ...
     */    get parent() {
        const t = this.l_.G();
        return t.Y() ? null : new Bc(this.firestore, 
     ...
     */    withConverter(t) {
        return new Uc(this.firestore, t, this.l_);
    }
}

function Kc(t, e, ...n) {
    if (t instanceof Sc && (t = t.Hl), Dc("collection", "path", e), t instanceof $c) {
        const s = X.nt(e, ...n);
        return Nc(s), new Uc(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof Bc || t instanceof Uc)) throw new k(O.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = X.nt(t.path, ...n).child(X.nt(e));
        return Nc(s), new Uc(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function Qc(t, e) {
    if (t = Oc(t, $c), Dc("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new k(O.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new qc(t, 
    /* converter= */ null, 
    /**
...
function Wc(t, e, ...n) {
    if (t instanceof Sc && (t = t.Hl), 
    // We allow omission of 'pathString' but explicitly prohibit passing in both
    // 'undefined' and 'null'.
    1 === arguments.length && (e = W.M()), Dc("doc", "path", e), t instanceof $c) {
        const s = X.nt(e, ...n);
        return Cc(s), new Bc(t, 
        /* converter= */ null, new et(s));
    }
    {
        if (!(t instanceof Bc || t instanceof Uc)) throw new k(O.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t.l_.child(X.nt(e, ...n));
        return Cc(s), new Bc(t.firestore, t instanceof Uc ? t.a_ : null, new et(s));
    }
}
 ...
 * Firestore database.
 */ function jc(t, e) {
    return t instanceof Sc && (t = t.Hl), e instanceof Sc && (e = e.Hl), (t instanceof Bc || t instanceof Uc) && (e instanceof Bc || e instanceof Uc) && (t.firestore === e.firestore && t.path === e.path && t.a_ === e.a_);
}
 ...
 * Firestore database.
 */ function Gc(t, e) {
    return t instanceof Sc && (t = t.Hl), e instanceof Sc && (e = e.Hl), t instanceof qc && e instanceof qc && (t.firestore === e.firestore && Te(t.__, e.__) && t.a_ === e.a_);
}
 ...
 */ class zc {
     ...
     */
    constructor(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new k(O.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new k(O.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.f_ = t, this.d_ = e;
    }
    /**
     ...
     * with an underscore.
     */    F(t) {
        return j(this.f_, t.f_) || j(this.d_, t.d_);
    }
}
...
/** A "context" object passed around while parsing user data. */ class Zc {
    ...
    /** Returns a new context with the specified settings overwritten. */    I_(t) {
        return new Zc(Object.assign(Object.assign({}, this.settings), t), this.p, this.Ut, this.ignoreUndefinedProperties, this.fieldTransforms, this.jt);
    }
    m_(t) {
        var e;
    ...
    g_(t) {
        return mu(t, this.settings.methodName, this.settings.y_ || !1, this.path, this.settings.p_);
    }
    ...
    R_(t) {
        ...
        if (Xc(this.T_) && Hc.test(t)) throw this.g_('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class tu {
    constructor(t, e, n) {
        this.p = t, this.ignoreUndefinedProperties = e, this.Ut = n || Gr(t);
    }
...
function eu(t) {
    const e = t.c_(), n = Gr(t.Zl);
    return new tu(t.Zl, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function nu(t, e, n, s, i, r = {}) {
    const o = t.b_(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    wu("Data must be an object, but it was:", o, s);
    const c = fu(s, o);
    let u, a;
    if (r.merge) u = new rt(o.jt), a = o.fieldTransforms; else if (r.mergeFields) {
        const t = [];
        for (const s of r.mergeFields) {
            const i = Eu(e, s, n);
            if (!o.contains(i)) throw new k(O.INVALID_ARGUMENT, `Field '${i}' is specified in your field mask but missing from your input data.`);
            Au(t, i) || t.push(i);
        }
        u = new rt(t), a = o.fieldTransforms.filter((t => u.ft(t.field)));
    } else u = null, a = o.fieldTransforms;
    return new Jc(new Ct(c), u, a);
}
...
class ou extends vc {
    ...
    v_(t) {
        const e = iu(this, t, 
        /*array=*/ !0), n = this.S_.map((t => _u(t, e))), s = new Ne(n);
...
class cu extends vc {
    ...
    v_(t) {
        const e = iu(this, t, 
        /*array=*/ !0), n = this.S_.map((t => _u(t, e))), s = new Oe(n);
        return new Le(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class uu extends vc {
    ...
    v_(t) {
        const e = new Me(t.Ut, pe(t.Ut, this.D_));
...
/** Parse update data from an update() call. */ function au(t, e, n, s) {
    const i = t.b_(1 /* Update */ , e, n);
    wu("Data must be an object, but it was:", i, s);
    const r = [], o = new Nt;
    st(s, ((t, s) => {
        const c = Iu(e, t, n);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                s instanceof Sc && (s = s.Hl);
        const u = i.P_(c);
        if (s instanceof su) 
    ...
    const c = new rt(r);
    return new Yc(o.Rt(), c, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function hu(t, e, n, s, i, r) {
    const o = t.b_(1 /* Update */ , e, n), c = [ Eu(e, s, n) ], u = [ i ];
    if (r.length % 2 != 0) throw new k(O.INVALID_ARGUMENT, `Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);
    for (let t = 0; t < r.length; t += 2) c.push(Eu(e, r[t])), u.push(r[t + 1]);
    const a = [], h = new Nt;
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = c.length - 1; t >= 0; --t) if (!Au(a, c[t])) {
        const e = c[t];
        let n = u[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                n instanceof Sc && (n = n.Hl);
        const s = o.P_(e);
        if (n instanceof su) 
        // Add it to the field mask, but don't add anything to updateData.
        a.push(e); else {
    ...
    const l = new rt(a);
    return new Yc(h.Rt(), l, o.fieldTransforms);
}
 ...
 */ function lu(t, e, n, s = !1) {
    return _u(n, t.b_(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function _u(t, e) {
    ...
    // from firestore-exp.
    t instanceof Sc && (t = t.Hl), du(t)) return wu("Unsupported field value:", e, t), 
    fu(t, e);
    if (t instanceof vc) 
 ...
 */
    return function(t, e) {
        ...
        if (!Xc(e.T_)) throw e.g_(t._methodName + "() can only be used with update() and set()");
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof Bc) {
            ...
            return {
                referenceValue: Qn(t.firestore.Zl || e.p, t.h_.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.g_("Unsupported field value: " + xc(t));
    }
    /**
...
function du(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof H || t instanceof zc || t instanceof yc || t instanceof Bc || t instanceof vc);
}
 ...
 */ function Eu(t, e, n) {
    ...
    // FieldPath.
    e instanceof Sc && (e = e.Hl), e instanceof pc) return e.zl;
    if ("string" == typeof e) return Iu(t, e);
    throw mu("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function Iu(t, e, n) {
    if (e.search(Tu) >= 0) throw mu(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return new pc(...e.split(".")).zl;
    } catch (s) {
        throw mu(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}

function mu(t, e, n, s, i) {
    const r = s && !s.Y(), o = void 0 !== i;
    let c = `Function ${e}() called with invalid data`;
    n && (c += " (via `toFirestore()`)"), c += ". ";
    let u = "";
    return (r || o) && (u += " (found", r && (u += " in field " + s), o && (u += " in document " + i), 
    u += ")"), new k(O.INVALID_ARGUMENT, c + t + u);
}

/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function Au(t, e) {
 ...
 */ class Ru {
    ...
    async k_(t) {
        if (this.M_(), this.mutations.length > 0) throw new k(O.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const n = x(t), s = Jn(n.Ut) + "/documents", i = {
                documents: e.map((t => jn(n.Ut, t)))
        ...
        return e.forEach((t => {
            t instanceof Mt || t instanceof kt ? this.F_(t) : C();
        })), e;
    }
    set(t, e) {
    ...
    delete(t) {
        this.write(new nn(t, this.Wt(t))), this.O_.add(t.toString());
    }
    async commit() {
     ...
     */    Wt(t) {
        ...
        return !this.O_.has(t.toString()) && e ? Ue.updateTime(e) : Ue.Kt();
    }
    /**
...
class Pu {
    constructor(t, e, n, s) {
        this.ls = t, this.gh = e, this.updateFunction = n, this.ws = s, this.B_ = 5, this.Ka = new zr(this.ls, "transaction_retry" /* TransactionRetry */);
    }
    ...
    q_() {
        this.Ka.ka((async () => {
            const t = new Ru(this.gh), e = this.U_(t);
            e && e.then((e => {
...
class Vu {
     ...
     */
    e, n) {
        this.credentials = t, this.ls = e, this.ma = n, this.user = V.UNAUTHENTICATED, this.clientId = W.M(), 
        this.W_ = () => {}, this.A = new ms, this.credentials.T((t => {
            b("FirestoreClient", "Received user=", t.uid), this.user = t, this.W_(t), this.A.resolve();
        }));
    }
     ...
     */    G_() {
        if (this.ls.z_) throw new k(O.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    terminate() {
        this.ls.H_();
        const t = new ms;
...
async function gu(t, e) {
    t.ls.Z_(), b("FirestoreClient", "Initializing OfflineComponentProvider");
...
async function yu(t, e) {
    ...
    t.j_((n => t.ls.yo((() => async function(t, e) {
        const n = x(t);
        n.ls.Z_(), b("RemoteStore", "RemoteStore received new credentials");
        const s = ao(n);
        // Tear down and re-create our network streams. This will ensure we get a
        // fresh auth token for the new user and re-fill the write pipeline with
        // new mutations from the LocalStore (since mutations are per-user).
                n.Sh.add(3 /* CredentialChange */), await no(n), s && 
...
async function pu(t) {
    return t.X_ || (b("FirestoreClient", "Using default OfflineComponentProvider"), 
    await gu(t, new Ac)), t.X_;
}

async function bu(t) {
    return t.Y_ || (b("FirestoreClient", "Using default OnlineComponentProvider"), await yu(t, new Vc)), 
    t.Y_;
}
...
function Su(t) {
    return pu(t).then((t => t.Vh));
}

function Du(t) {
    return bu(t).then((t => t.wl));
}

function Cu(t) {
    return bu(t).then((t => t.uu));
}

async function Nu(t) {
    const e = await bu(t), n = e.El;
    return n.Uh = Ko.bind(null, e.uu), n.Wh = Wo.bind(null, e.uu), n;
}

/** Enables the network connection and re-enqueues all pending operations. */ function xu(t) {
    return t.ls.enqueue((async () => {
        const e = await vu(t), n = await Du(t);
        return e.Po(!0), function(t) {
            const e = x(t);
            return e.Sh.delete(0 /* UserDisabled */), eo(e);
        }(n);
    }));
}
...
/** Disables the network connection. Pending operations will not complete. */ function Ou(t) {
    return t.ls.enqueue((async () => {
        ...
        return e.Po(!1), async function(t) {
            const e = x(t);
            e.Sh.add(0 /* UserDisabled */), await no(e), 
 ...
 */ function ku(t, e) {
    ...
    return t.ls.Rs((async () => async function(t, e, n) {
        try {
            ...
            s instanceof kt ? n.resolve(s) : s instanceof Mt ? n.resolve(null) : n.reject(new k(O.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
        } catch (t) {
    ...
    return t.ls.Rs((async () => function(t, e, n, s, i) {
        const r = new gc({
            next: r => {
                ...
                i.reject(new k(O.UNAVAILABLE, "Failed to get document because the client is offline.")) : c && r.fromCache && s && "server" === s.source ? i.reject(new k(O.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(r);
            },
            error: t => i.reject(t)
        }), o = new Mo(ue(n.path), r, {
            includeMetadataChanges: !0,
            Xh: !0
        });
        return Co(t, o);
    }(await Nu(t), t.ls, e, n, s))), s.promise;
}
...
function Fu(t, e) {
    ...
    return t.ls.Rs((async () => async function(t, e, n) {
        try {
            ...
            /* usePreviousResults= */ !0), i = new Lo(e, s.mc), r = i.rl(s.documents), o = i.di(r, 
            /* updateLimboDocuments= */ !1);
    ...
    return t.ls.Rs((async () => function(t, e, n, s, i) {
        const r = new gc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.Rs((() => No(t, o))), n.fromCache && "server" === s.source ? i.reject(new k(O.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Mo(n, r, {
            includeMetadataChanges: !0,
 ...
 */ function Bu(t, e) {
    ...
    return t.ls.Rs((async () => {
        const s = await function(t) {
            return bu(t).then((t => t.gh));
        }(t);
        new Pu(t.ls, s, e, n).run();
    })), n.promise;
}
...
class qu {
    constructor() {
        ...
        this.Ka = new zr(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.af = () => {
            const t = jr();
            t && b("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.Ka.Fa();
        };
        const t = jr();
 ...
 */
    ...
    Er(t, e, n) {
        ...
        const s = Ds.Es(this, t, e, n, (t => this.ff(t)));
...
class Ku extends $c {
    /** @hideconstructor */
    constructor(t, e) {
        super(t, e), this.If = new qu, this.Jl = "name" in t ? t.name : "[DEFAULT]";
    }
    u_() {
        return this.mf || 
        // The client must be initialized to ensure that all subsequent API
        // usage throws an exception.
        Gu(this), this.mf.terminate();
    }
}
 ...
 */ function Qu(e, n) {
    ...
    if (void 0 !== n.cacheSizeBytes && -1 !== n.cacheSizeBytes && n.cacheSizeBytes < 1048576) throw new k(O.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return s.r_(n), s;
}
 ...
 */ function zu(t, e) {
    na(t = Oc(t, Ku));
    const n = ju(t), s = t.c_(), i = new Vc;
    return Ju(n, i, new Rc(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Hu(t) {
    na(t = Oc(t, Ku));
    const e = ju(t), n = t.c_(), s = new Vc;
    return Ju(e, s, new Pc(s, n.cacheSizeBytes));
}
 ...
 */ function Ju(t, e, n) {
    ...
    return t.ls.enqueue((async () => {
        try {
            await gu(t, n), await yu(t, e), s.resolve();
        } catch (t) {
            if (!
            /**
...
function Yu(t) {
    if (t.n_ && !t.s_) throw new k(O.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    const e = new ms;
 ...
 */ function Xu(t) {
    return function(t) {
        const e = new ms;
        return t.ls.Rs((async () => Xo(await Cu(t), e))), e.promise;
    }(ju(t = Oc(t, Ku)));
}
...
function na(t) {
    if (t.n_ || t.s_) throw new k(O.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
...
class sa {
    Af(t, e = "none") {
        switch (It(t)) {
          ...
          case 6 /* BlobValue */ :
            return this.Vf(lt(t.bytesValue));
    ...
    yf(t) {
        return new zc(ht(t.latitude), ht(t.longitude));
    }
    pf(t, e) {
 ...
 */ class ia {
     ...
     */    get ref() {
        return new Bc(this.Sf, this.a_, this.h_);
    }
    /**
     ...
     */    data() {
        if (this.Cf) {
            if (this.a_) {
                ...
                const t = new ra(this.Sf, this.Df, this.h_, this.Cf, 
                /* converter= */ null);
    ...
    get(t) {
        if (this.Cf) {
            const e = this.Cf.data().field(oa("DocumentSnapshot.get", t));
 ...
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */ function oa(t, e) {
    return "string" == typeof e ? Iu(t, e) : e instanceof Sc ? e.Hl.zl : e.zl;
}
 ...
 */ class ua extends ia {
     ...
     */    data(t = {}) {
        if (this.Cf) {
            if (this.a_) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                const e = new aa(this.Sf, this.Df, this.h_, this.Cf, this.metadata, 
                /* converter= */ null);
    ...
    get(t, e = {}) {
        if (this.Cf) {
            const n = this.Cf.data().field(oa("DocumentSnapshot.get", t));
 ...
 */ class ha {
    /** @hideconstructor */
    constructor(t, e, n, s) {
        this.Sf = t, this.Df = e, this.xf = s, this.metadata = new ca(s.hasPendingWrites, s.fromCache), 
        this.query = n;
    }
     ...
     */    forEach(t, e) {
        this.xf.docs.forEach((n => {
            t.call(e, new aa(this.Sf, this.Df, n.key, n, new ca(this.xf.Se.has(n.key), this.xf.fromCache), this.query.a_));
        }));
    }
    /**
     ...
     */    docChanges(t = {}) {
        ...
        if (e && this.xf.Ce) throw new k(O.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t.xf.ve.Y()) {
                ...
                return t.xf.docChanges.map((s => {
                    const i = new aa(t.Sf, t.Df, s.doc.key, s.doc, new ca(t.xf.Se.has(s.doc.key), t.xf.fromCache), t.query.a_);
                    return e = s.doc, {
                        type: "added",
                        doc: i,
                        oldIndex: -1,
            ...
            }
            {
                ...
                return t.xf.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new aa(t.Sf, t.Df, e.doc.key, e.doc, new ca(t.xf.Se.has(e.doc.key), t.xf.fromCache), t.query.a_);
                    let i = -1, r = -1;
 ...
 */ function _a(t, e) {
    return t instanceof ua && e instanceof ua ? t.Sf === e.Sf && t.h_.isEqual(e.h_) && (null === t.Cf ? null === e.Cf : t.Cf.isEqual(e.Cf)) && t.a_ === e.a_ : t instanceof ha && e instanceof ha && (t.Sf === e.Sf && Gc(t.query, e.query) && t.metadata.isEqual(e.metadata) && t.xf.isEqual(e.xf));
}
 ...
 * limitations under the License.
 */ function fa(t) {
    if (he(t) && 0 === t.Ct.length) throw new k(O.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class Ea extends da {
    ...
    Mf(t) {
        const e = eu(t.firestore), n = function(t, e, n, s, i, r, o) {
            let c;
            if (i.rt()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === r || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === r) throw new k(O.INVALID_ARGUMENT, `Invalid Query. You can't perform '${r}' queries on FieldPath.documentId().`);
                if ("in" /* IN */ === r || "not-in" /* NOT_IN */ === r) {
                    Ca(o, r);
                    const e = [];
                    for (const n of o) e.push(Da(s, t, n));
                    c = {
                        arrayValue: {
                            values: e
                        }
            ...
            } else "in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || Ca(o, r), 
            c = lu(n, e, o, 
            /* allowArrays= */ "in" /* IN */ === r || "not-in" /* NOT_IN */ === r);
            const u = Qt.create(i, r, c);
            return function(t, e) {
                if (e.Dt()) {
                    const n = _e(t);
                    if (null !== n && !n.isEqual(e.field)) throw new k(O.INVALID_ARGUMENT, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${e.field.toString()}'`);
                    const s = le(t);
                    null !== s && Na(t, e.field, s);
                }
                const n = function(t, e) {
 ...
 */
                ...
                throw n === e.op ? new k(O.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new k(O.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
            }(t, u), u;
        }(t.__, "where", e, t.firestore.Zl, this.Ff, this.$f, this.Lf);
        return new qc(t.firestore, t.a_, function(t, e) {
...
class Ia extends da {
    ...
    Mf(t) {
        const e = function(t, e, n) {
            if (null !== t.startAt) throw new k(O.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new k(O.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            const s = new ne(e, n);
            return function(t, e) {
                if (null === le(t)) {
                    // This is the first order by. It must match any inequality.
                    const n = _e(t);
                    null !== n && Na(t, n, e.field);
                }
            }(t, s), s;
        }
        /**
...
class Aa extends da {
    ...
    Mf(t) {
        return new qc(t.firestore, t.a_, Ee(t.__, this.qf, this.Uf));
    }
}
 ...
 * @returns The created `Query`.
 */ function Ra(t) {
    return kc("limit", t), new Aa("limit", t, "F" /* First */);
}
 ...
 * @returns The created `Query`.
 */ function Pa(t) {
    return kc("limitToLast", t), new Aa("limitToLast", t, "L" /* Last */);
}
...
class Va extends da {
    ...
    Mf(t) {
        const e = Sa(t, this.type, this.Kf, this.Qf);
        return new qc(t.firestore, t.a_, function(t, e) {
...
function ga(...t) {
    return new Va("startAt", t, /*before=*/ !0);
}

function ya(...t) {
    return new Va("startAfter", t, 
    /*before=*/ !1);
}
...
/** Helper function to create a bound from a document or fields */ function Sa(t, e, n, s) {
    if (n[0] instanceof Sc && (n[0] = n[0].Hl), n[0] instanceof ia) return function(t, e, n, s, i) {
        if (!s) throw new k(O.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        const r = [];
        ...
        // results.
            ...
            if (_t(t)) throw new k(O.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
                const t = n.field.et();
                throw new k(O.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${t}' (used as the orderBy) does not exist.`);
            }
            r.push(t);
        }
        return new te(r, i);
 ...
 */ (t.__, t.firestore.Zl, e, n[0].Cf, s);
    {
        const i = eu(t.firestore);
        return function(t, e, n, s, i, r) {
            // Use explicit order by's because it has to match the query the user made
            const o = t.Ct;
            if (i.length > o.length) throw new k(O.INVALID_ARGUMENT, `Too many arguments provided to ${s}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
            const c = [];
            for (let r = 0; r < i.length; r++) {
                const u = i[r];
                if (o[r].field.rt()) {
                    if ("string" != typeof u) throw new k(O.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof u}`);
                    if (!fe(t) && -1 !== u.indexOf("/")) throw new k(O.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${u}' contains a slash.`);
                    const n = t.path.child(X.nt(u));
                    if (!et.lt(n)) throw new k(O.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new et(n);
                    c.push(yt(e, i));
                } else {
                    const t = lu(n, s, u);
...
function Da(t, e, n) {
    if (n instanceof Sc && (n = n.Hl), "string" == typeof n) {
        if ("" === n) throw new k(O.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!fe(e) && -1 !== n.indexOf("/")) throw new k(O.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const s = e.path.child(X.nt(n));
        if (!et.lt(s)) throw new k(O.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return yt(t, new et(s));
    }
    if (n instanceof Bc) return yt(t, n.h_);
    throw new k(O.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + xc(n) + ".");
}
 ...
 * array requirements.
 */ function Ca(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new k(O.INVALID_ARGUMENT, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
    if (t.length > 10) throw new k(O.INVALID_ARGUMENT, `Invalid Query. '${e.toString()}' filters support a maximum of 10 elements in the value array.`);
}

function Na(t, e, n) {
    if (!n.isEqual(e)) throw new k(O.INVALID_ARGUMENT, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`);
}
 ...
 */ class ka {
    /** @hideconstructor */
    constructor(t, e) {
        this.Sf = t, this.Wf = e, this.jf = [], this.Gf = !1, this.zf = eu(t);
    }
    set(t, e, n) {
        this.Hf();
        const s = Ma(t, this.Sf), i = xa(s.a_, e, n), r = nu(this.zf, "WriteBatch.set", s.h_, i, null !== s.a_, n);
        return this.jf.push(r.w_(s.h_, Ue.Kt())), this;
    }
    update(t, e, n, ...s) {
        this.Hf();
        const i = Ma(t, this.Sf);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let r;
        return e instanceof Sc && (e = e.Hl), r = "string" == typeof e || e instanceof pc ? hu(this.zf, "WriteBatch.update", i.h_, e, n, s) : au(this.zf, "WriteBatch.update", i.h_, e), 
        this.jf.push(r.w_(i.h_, Ue.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        this.Hf();
        const e = Ma(t, this.Sf);
        return this.jf = this.jf.concat(new nn(e.h_, Ue.Kt())), this;
    }
    /**
    ...
    Hf() {
        if (this.Gf) throw new k(O.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}

function Ma(t, e) {
    if (t instanceof Sc && (t = t.Hl), t.firestore !== e) throw new k(O.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
function $a(t) {
    t = Oc(t, Bc);
    const e = Oc(t.firestore, Ku);
    return Mu(ju(e), t.h_).then((n => Xa(e, t, n)));
}
 ...
 */ function Ba(t) {
    t = Oc(t, Bc);
    const e = Oc(t.firestore, Ku), n = ju(e), s = new La(e);
    return ku(n, t.h_).then((n => new ua(e, s, t.h_, n, new ca(n instanceof kt && n.gt, 
    /* fromCache= */ !0), t.a_)));
}
 ...
 */ function Ua(t) {
    t = Oc(t, qc);
    const e = Oc(t.firestore, Ku), n = ju(e), s = new La(e);
    return fa(t.__), $u(n, t.__).then((n => new ha(e, s, t, n)));
}
 ...
 */ function Ka(t) {
    t = Oc(t, qc);
    const e = Oc(t.firestore, Ku), n = ju(e), s = new La(e);
    return Fu(n, t.__).then((n => new ha(e, s, t, n)));
}
...
function Wa(t, e, n) {
    t = Oc(t, Bc);
    const s = Oc(t.firestore, Ku), i = xa(t.a_, e, n);
    return Ya(s, [ nu(eu(s), "setDoc", t.h_, i, null !== t.a_, n).w_(t.h_, Ue.Kt()) ]);
}

function ja(t, e, n, ...s) {
    t = Oc(t, Bc);
    const i = Oc(t.firestore, Ku), r = eu(i);
    let o;
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e instanceof Sc && (e = e.Hl), o = "string" == typeof e || e instanceof pc ? hu(r, "updateDoc", t.h_, e, n, s) : au(r, "updateDoc", t.h_, e);
    return Ya(i, [ o.w_(t.h_, Ue.exists(!0)) ]);
}
 ...
 */ function Ga(t) {
    return Ya(Oc(t.firestore, Ku), [ new nn(t.h_, Ue.Kt()) ]);
}
 ...
 */ function za(t, e) {
    const n = Oc(t.firestore, Ku), s = Wc(t), i = xa(t.a_, e);
    return Ya(n, [ nu(eu(t.firestore), "addDoc", s.h_, i, null !== t.a_, {}).w_(s.h_, Ue.exists(!1)) ]).then((() => s));
}
...
function Ha(t, ...e) {
    ...
    let u, a, h;
    if (t instanceof Bc) a = Oc(t.firestore, Ku), h = ue(t.h_.path), u = {
        next: n => {
            e[o] && e[o](Xa(a, t, n));
        },
        error: e[o + 1],
        ...
        const n = Oc(t, qc);
        a = Oc(n.firestore, Ku), h = n.__;
        const s = new La(a);
        u = {
            next: t => {
                e[o] && e[o](new ha(a, s, n, t));
            },
            error: e[o + 1],
            complete: e[o + 2]
        }, fa(t.__);
    ...
    return function(t, e, n, s) {
        const i = new gc(s), r = new Mo(e, i, n);
        return t.ls.Rs((async () => Co(await Nu(t), r))), () => {
            i.jl(), t.ls.Rs((async () => No(await Nu(t), r)));
        };
    }(ju(a), h, c, u);
}

function Ja(t, e) {
    return Lu(ju(t = Oc(t, Ku)), Fa(e) ? e : {
        next: e
    });
}

/** Locally writes `mutations` on the async queue. */ function Ya(t, e) {
    return function(t, e) {
        const n = new ms;
        return t.ls.Rs((async () => jo(await Cu(t), e, n))), n.promise;
    }(ju(t), e);
}
 ...
 */ function Xa(t, e, n) {
    const s = n.docs.get(e.h_), i = new La(t);
    return new ua(t, i, e.h_, s, new ca(n.hasPendingWrites, n.fromCache), e.a_);
}
 ...
 */ class Za extends class {
    /** @hideconstructor */
    constructor(t, e) {
        this.Sf = t, this.Jf = e, this.zf = eu(t);
    }
    /**
     ...
     */    get(t) {
        const e = Ma(t, this.Sf), n = new Oa(this.Sf);
        return this.Jf.k_([ e.h_ ]).then((t => {
            if (!t || 1 !== t.length) return C();
            const s = t[0];
            if (s instanceof Mt) return new ia(this.Sf, n, e.h_, null, e.a_);
            if (s instanceof kt) return new ia(this.Sf, n, s.key, s, e.a_);
            throw C();
        }));
    }
    set(t, e, n) {
        const s = Ma(t, this.Sf), i = xa(s.a_, e, n), r = nu(this.zf, "Transaction.set", s.h_, i, null !== s.a_, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return e instanceof Sc && (e = e.Hl), r = "string" == typeof e || e instanceof pc ? hu(this.zf, "Transaction.update", i.h_, e, n, s) : au(this.zf, "Transaction.update", i.h_, e), 
     ...
     * @returns A `DocumentSnapshot` with the read data.
     */    get(t) {
        const e = Ma(t, this.Sf), n = new La(this.Sf);
        return super.get(t).then((t => new ua(this.Sf, n, e.h_, t.Cf, new ca(
        /* hasPendingWrites= */ !1, 
        /* fromCache= */ !1), e.a_)));
    }
}
 ...
 * writes.
 */ function oh(t) {
    return ju(t = Oc(t, Ku)), new ka(t, (e => Ya(t, e)));
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ n(new i("firestore-exp", (t => ((t, e) => new Ku(t, e))(t.getProvider("app-exp").getImmediate(), t.getProvider("auth-internal"))), "PUBLIC" /* PUBLIC */)), 
s("firestore-exp", "2.1.4", "node");

export { yc as Bytes, Uu as CACHE_SIZE_UNLIMITED, Uc as CollectionReference, Bc as DocumentReference, ua as DocumentSnapshot, pc as FieldPath, vc as FieldValue, Ku as FirebaseFirestore, k as FirestoreError, zc as GeoPoint, qc as Query, da as QueryConstraint, aa as QueryDocumentSnapshot, ha as QuerySnapshot, ca as SnapshotMetadata, H as Timestamp, Za as Transaction, ka as WriteBatch, za as addDoc, ih as arrayRemove, sh as arrayUnion, Yu as clearIndexedDbPersistence, Kc as collection, Qc as collectionGroup, Ga as deleteDoc, eh as deleteField, ta as disableNetwork, Wc as doc, bc as documentId, zu as enableIndexedDbPersistence, Hu as enableMultiTabIndexedDbPersistence, Zu as enableNetwork, va as endAt, ba as endBefore, $a as getDoc, Ba as getDocFromCache, qa as getDocFromServer, Ua as getDocs, Ka as getDocsFromCache, Qa as getDocsFromServer, Wu as getFirestore, rh as increment, Qu as initializeFirestore, Ra as limit, Pa as limitToLast, Ha as onSnapshot, Ja as onSnapshotsInSync, ma as orderBy, wa as query, Gc as queryEqual, jc as refEqual, th as runTransaction, nh as serverTimestamp, Wa as setDoc, p as setLogLevel, _a as snapshotEqual, ya as startAfter, ga as startAt, ea as terminate, ja as updateDoc, Lc as useFirestoreEmulator, Xu as waitForPendingWrites, Ta as where, oh as writeBatch };
