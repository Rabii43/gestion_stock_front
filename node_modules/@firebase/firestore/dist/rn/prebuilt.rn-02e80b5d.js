 ...
 */ class Ps {
    ...
    constructor(t, n, s) {
        ...
        // log on 12.2.
        12.2 === Ps.Kn(getUA()) && P("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    ...
    /** Returns true if IndexedDB is available in the current environment. */    static Wn() {
        ...
        // Check the UA string to find out the browser.
                const t = getUA(), n = Ps.Kn(t), s = 0 < n && n < 10, i = Ps.Gn(t), r = 0 < i && i < 4.5;
        // IE 10
 ...
 */ class cr {
    ...
    /** Returns all local documents matching the specified query. */    Wr(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.lc(e, i);
            return (ce(e) || ae(e)) && this._c(e.limitType, r, s, n) ? this.hc(t, e) : (A() <= LogLevel.DEBUG && R("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Te(e)), 
    ...
    hc(t, e) {
        return A() <= LogLevel.DEBUG && R("QueryEngine", "Using full collection scan to execute query:", Te(e)), 
...
class {
    ...
    xu(t, e) {
        const a = [ this.Vu, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], u = createWebChannelTransport(), h = getStatEventTarget(), l = {
...
export { $, Gu as G, H, Qu as Q, Uu as U, Wu as W, Zu as Z, Hu as a, sh as b, ch as c, Za as d, eh as e, tu as f, hh as h, ih as i, ju as j, oh as o, sa as s, th as t, uh as u };
//# sourceMappingURL=prebuilt.rn-02e80b5d.js.map
