 ...
 */ function V(t = "Unexpected state") {
    ...
    const e = "FIRESTORE (8.2.5) INTERNAL ASSERTION FAILED: " + t;
 ...
 */ class k {
     ...
     */    static fromBase64String(t) {
        try {
            ...
            throw new F(O.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + t);
        }
    }
    /**
...
/** Helper function to assert Uint8Array is available at runtime. */ function L() {
    if ("undefined" == typeof Uint8Array) throw new F(O.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}
...
U.P = new U("google-credentials-uid"), U.g = new U("first-party-uid");
...
class W {
    constructor(t) {
        ...
        this.currentUser = U.UNAUTHENTICATED, this.N = !1, 
        /**
    ...
    getToken() {
        ...
        this.O !== t ? (R("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
    ...
    F() {
        ...
        return p(null === t || "string" == typeof t), new U(t);
    }
}
 ...
 */ class j {
    constructor(t, e) {
        this.k = t, this.M = e, this.type = "FirstParty", this.user = U.g;
    }
    get V() {
        const t = {
...
class H {
     ...
     */
    constructor(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new F(O.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new F(O.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new F(O.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new F(O.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ class X extends Y {
     ...
     */    static ct(...t) {
        ...
        const e = [];
        for (const n of t) {
            if (n.indexOf("//") >= 0) throw new F(O.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`);
...
/** A dot-separated path for navigating sub-objects within a document. */ class tt extends Y {
    ...
    ot() {
        return this.rt().map((t => (t = t.replace(/\\/g, "\\\\").replace(/`/g, "\\`"), tt.ut(t) || (t = "`" + t + "`"), 
        t))).join(".");
    }
    toString() {
        return this.ot();
     ...
     */    static _t(t) {
        ...
        let n = "", s = 0;
        const i = () => {
            if (0 === n.length) throw new F(O.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            e.push(n), n = "";
        };
        let r = !1;
        for (;s < t.length; ) {
            const e = t[s];
            if ("\\" === e) {
                if (s + 1 === t.length) throw new F(O.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                const e = t[s + 1];
                if ("\\" !== e && "." !== e && "`" !== e) throw new F(O.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                n += e, s += 2;
            } else "`" === e ? (r = !r, s++) : "." !== e || r ? (n += e, s++) : (i(), s++);
        }
        if (i(), r) throw new F(O.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new tt(e);
    }
    static at() {
        return new tt([]);
 ...
 */ class et {
    ...
    static ft(t) {
        return new et(X.ct(t));
    }
    static dt(t) {
        return new et(X.ct(t).X(5));
    }
    /** Returns true if the document is in the specified collectionId. */    wt(t) {
        return this.path.length >= 2 && this.path.get(this.path.length - 2) === t;
    }
    isEqual(t) {
        return null !== t && 0 === X.J(this.path, t.path);
    }
    toString() {
        return this.path.toString();
    }
    static J(t, e) {
        return X.J(t.path, e.path);
    }
    static Et(t) {
        return t.length % 2 == 0;
    }
...
/** Extracts the backend's type order for the provided value. */ function Et(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? ht(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : V();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Tt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return C(t.arrayValue.values || [], e.arrayValue.values || [], Tt);
...
function At(t, e) {
    ...
    const n = ct(t), s = ct(e), i = D(n.seconds, s.seconds);
...
function Pt(t) {
    ...
    et.dt(n).toString()) : "geoPointValue" in t ? `geo(${(e = t.geoPointValue).latitude},${e.longitude})` : "arrayValue" in t ? function(t) {
        let e = "[", n = !0;
 ...
 */ class Dt {
    ...
    /** Returns an ObjectValue with all mutations applied. */    yt() {
        const t = this.gt(tt.at(), this.Rt);
        return null != t ? new St(t) : this.At;
    }
    /**
     ...
     */    gt(t, e) {
        let n = !1;
        const s = this.At.field(t), i = vt(s) ? // If there is already data at the current path, base our
 ...
 */ class Nt extends xt {
    ...
    isEqual(t) {
        return t instanceof Nt && this.key.isEqual(t.key) && this.version.isEqual(t.version) && this.bt === t.bt && this.hasCommittedMutations === t.hasCommittedMutations && this.Vt.isEqual(t.Vt);
    }
    toString() {
 ...
 */ class Ft extends xt {
    ...
    isEqual(t) {
        return t instanceof Ft && t.version.isEqual(this.version) && t.key.isEqual(this.key);
    }
}
...
function Lt(t) {
    ...
    if (null === e.St) {
        ...
        t += Zt(e.startAt)), e.endAt && (t += "|ub:", t += Zt(e.endAt)), e.St = t;
    }
    return e.St;
}
...
function $t(t) {
    ...
    t.filters.length > 0 && (e += `, filters: [${t.filters.map((t => {
        return `${(e = t).field.ot()} ${e.op} ${Rt(e.value)}`;
...
function qt(t) {
    return et.Et(t.path) && null === t.collectionGroup && 0 === t.filters.length;
}
...
class Ut extends class {} {
     ...
     */    static create(t, e, n) {
        return t.ht() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.Dt(t, e, n) : new Kt(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new zt(t, n) : "in" /* IN */ === e ? new Ht(t, n) : "not-in" /* NOT_IN */ === e ? new Jt(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Yt(t, n) : new Ut(t, e, n);
    }
    static Dt(t, e, n) {
    ...
    matches(t) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.Ct(mt(e, this.value)) : null !== e && Et(this.value) === Et(e) && this.Ct(mt(e, this.value));
...
function Qt(t) {
    ...
    return t.field.ot() + t.op.toString() + Rt(t.value);
}

class Kt extends Ut {
    constructor(t, e, n) {
        super(t, e, n), this.key = et.dt(n.referenceValue);
    }
    matches(t) {
        const e = et.J(t.key, this.key);
        return this.Ct(e);
    }
}
...
function Gt(t, e) {
    var n;
    return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((t => et.dt(t.referenceValue)));
}
...
/** A Filter that implements the array-contains operator. */ class zt extends Ut {
    ...
    matches(t) {
        const e = t.field(this.field);
        return Vt(e) && It(e.arrayValue, this.value);
    }
}
...
/** A Filter that implements the array-contains-any operator. */ class Yt extends Ut {
    ...
    matches(t) {
        const e = t.field(this.field);
        return !(!Vt(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => It(this.value.arrayValue, t)));
    }
}
 ...
 */ function ne(t, e, n) {
    ...
    for (let i = 0; i < t.position.length; i++) {
        ...
        if (r.field.ht()) s = et.J(et.dt(o.referenceValue), n.key); else {
 ...
 */ function _e(t) {
    ...
    if (null === e.Ot) {
        ...
        t.ht() || e.Ot.push(new te(t)), e.Ot.push(new te(tt.lt(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function fe(t) {
    const e = b(t);
    if (!e.Ft) if ("F" /* First */ === e.limitType) e.Ft = Mt(e.path, e.collectionGroup, _e(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        e.Ft = Mt(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.Ft;
}

function de(t, e, n) {
    return new ie(t.path, t.collectionGroup, t.Nt.slice(), t.filters.slice(), e, n, t.startAt, t.endAt);
}
...
function Ee(t) {
    return `${Lt(fe(t))}|lt:${t.limitType}`;
}

function Te(t) {
    return `Query(target=${$t(fe(t))}; limitType=${t.limitType})`;
}

/** Returns whether `doc` matches the constraints of `query`. */ function Ie(t, e) {
    return function(t, e) {
        const n = e.key.path;
        return null !== t.collectionGroup ? e.key.wt(t.collectionGroup) && t.path.st(n) : et.Et(t.path) ? t.path.isEqual(n) : t.path.it(n);
    }
    /**
...
function Ae(t, e, n) {
    const s = t.field.ht() ? et.J(e.key, n.key) : function(t, e, n) {
 ...
 */ class Re {
    ...
    /** Creates a new target data instance with an updated sequence number. */    Lt(t) {
        return new Re(this.target, this.targetId, this.kt, t, this.Mt, this.lastLimboFreeSnapshotVersion, this.resumeToken);
    }
    /**
     ...
     */    Bt(t) {
        return new Re(this.target, this.targetId, this.kt, this.sequenceNumber, this.Mt, t, this.resumeToken);
    }
}
 ...
 */ function pe(t, e, n) {
    ...
    }(n, e) : t instanceof De ? Ce(t, e) : t instanceof xe ? Ne(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        const n = ve(t, e), s = Fe(n) + Fe(t.Qt);
        return gt(n) && gt(t.Qt) ? ye(s) : Pe(t.Kt, s);
    }(t, e);
}
 ...
 */ function be(t, e, n) {
    ...
    // applications.
    return t instanceof De ? Ce(t, e) : t instanceof xe ? Ne(t, e) : n;
}
...
/** Transforms an array value via a union operation. */ class De extends Ve {
    constructor(t) {
...
/** Transforms an array value via a remove operation. */ class xe extends Ve {
    constructor(t) {
        super(), this.elements = t;
    }
}
...
function Le(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof De && e instanceof De || t instanceof xe && e instanceof xe ? C(t.elements, e.elements, Tt) : t instanceof Oe && e instanceof Oe ? Tt(t.Qt, e.Qt) : t instanceof Se && e instanceof Se;
 ...
 */ class Be {
    ...
    /** Creates a new empty Precondition. */    static Wt() {
        return new Be;
    }
    ...
    /** Returns whether this Precondition is empty. */    get jt() {
 ...
 */ function qe(t, e) {
    return void 0 !== t.updateTime ? e instanceof Nt && e.version.isEqual(t.updateTime) : void 0 === t.exists || t.exists === e instanceof Nt;
}
 ...
 */ function Qe(t, e, n) {
    return t instanceof ze ? function(t, e, n) {
        ...
        return new Nt(t.key, n.version, s, {
 ...
 */ function We(t, e) {
    return function(t, e) {
        let n = null;
        for (const s of t) {
            const t = e instanceof Nt ? e.field(s.field) : void 0, i = ve(s.transform, t || null);
...
function je(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.Gt.isEqual(e.Gt) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && C(t, e, ((t, e) => Le(t, e)));
 ...
 */ function Ge(t) {
    return t instanceof Nt ? t.version : J.min();
}
...
function Je(t, e, n) {
    let s;
    return s = e instanceof Nt ? e.data() : St.empty(), s = function(t, e) {
        const n = new Dt(e);
...
function Ye(t, e, n) {
    ...
    for (let i = 0; i < n.length; i++) {
        ...
        let c = null;
        e instanceof Nt && (c = e.field(r.field)), s.push(be(o, c, n[i]));
    }
    return s;
}
 ...
 */ function Xe(t, e, n, s) {
    ...
    for (const s of t) {
        const t = s.transform;
        let r = null;
        n instanceof Nt && (r = n.field(s.field)), i.push(pe(t, r, e));
    }
    return i;
}
...
function cn(t) {
    ...
    return P("GRPC error has no .code"), O.UNKNOWN;
    switch (t) {
      case sn.OK:
        return O.OK;
...
class an {
    constructor(t, e) {
        this.J = t, this.root = e || hn.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
    Ht(t, e) {
        return new an(this.J, this.root.Ht(t, e, this.J).copy(null, null, hn.Jt, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new an(this.J, this.root.remove(t, this.J).copy(null, null, hn.Jt, null, null));
    }
    ...
    ee() {
        return new un(this.root, null, this.J, !1);
    }
    ne(t) {
        return new un(this.root, t, this.J, !1);
    }
    se() {
        return new un(this.root, null, this.J, !0);
    }
    ie(t) {
        return new un(this.root, t, this.J, !0);
    }
}
...
class hn {
    ...
    le() {
        if (this.left.nt()) return hn.EMPTY;
        let t = this;
    ...
    me() {
        if (this._e() && this.left._e()) throw V();
        if (this.right._e()) throw V();
        const t = this.left.me();
        if (t !== this.right.me()) throw V();
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
hn.EMPTY = null, hn.RED = !0, hn.Jt = !1;
...
class ln {
    ...
    ee() {
        return new _n(this.data.ee());
    }
    ne(t) {
        return new _n(this.data.ne(t));
    }
...
const En = new an(et.J);

function Tn() {
    return En;
}

const In = new an(et.J);

function mn() {
    return In;
}

const An = new ln(et.J);
 ...
 */ class gn {
    ...
    constructor(t) {
        ...
        this.J = t ? (e, n) => t(e, n) || et.J(e.key, n.key) : (t, e) => et.J(t.key, e.key), 
        this.Ve = Tn(), this.pe = new an(this.J);
    }
    /**
...
class pn {
    ...
    isEqual(t) {
        if (!(this.fromCache === t.fromCache && this.xe === t.xe && this.Ce.isEqual(t.Ce) && we(this.query, t.query) && this.docs.isEqual(t.docs) && this.De.isEqual(t.De))) return !1;
 ...
 */ class bn {
    ...
    static $e(t, e) {
        const n = new Map;
        return n.set(t, vn.Be(t, e)), new bn(J.min(), n, yn(), dn(), Rn());
    }
}
 ...
 */ class Sn {
     ...
     */
    s) {
        this.We = t, this.removedTargetIds = e, this.key = n, this.je = s;
    }
}
...
/** Tracks the internal state of a Watch target. */ class xn {
     ...
     */    nn() {
        ...
        })), new vn(this.Je, this.Ye, t, e, n);
    }
    /**
     * Resets the document changes and sets `hasPendingChanges` to false.
     */    sn() {
        this.Xe = !1, this.He = Fn();
    }
    rn(t, e) {
...
class Nn {
     ...
     */    wn(t) {
        for (const e of t.We) t.je instanceof Nt ? this.En(e, t.je) : t.je instanceof Ot && this.Tn(e, t.key, t.je);
        for (const e of t.removedTargetIds) this.Tn(e, t.key, t.je);
    }
     ...
     */    pn(t) {
        ...
        this.ln.forEach(((n, s) => {
            ...
            if (i) {
                if (n.qe && qt(i.target)) {
                    ...
                    null !== this._n.get(e) || this.bn(s, e) || this.Tn(s, e, new Ot(e, t));
                }
        ...
        const s = new bn(t, e, this.dn, this._n, n);
        return this._n = dn(), this.fn = On(), this.dn = new ln(D), s;
    }
    /**
    ...
    An(t) {
        let e = this.ln.get(t);
        return e || (e = new xn, this.ln.set(t, e)), e;
    }
    vn(t) {
        let e = this.fn.get(t);
        return e || (e = new ln(D), this.fn = this.fn.Ht(t, e)), e;
    }
    /**
...
function jn(t, e) {
    const n = Kn(e);
    if (n.get(1) !== t.T.projectId) throw new F(O.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.T.projectId);
    if (n.get(3) !== t.T.database) throw new F(O.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.T.database);
    return new et(Jn(n));
}
...
function zn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? X.at() : Jn(e);
}

function Hn(t) {
    return new X([ "projects", t.T.projectId, "databases", t.T.database ]).ot();
}

function Jn(t) {
    return p(t.length > 4 && "documents" === t.get(4)), t.X(5);
}
...
function ts(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            return t.qt ? (p(void 0 === e || "string" == typeof e), N.fromBase64String(e || "")) : (p(void 0 === e || e instanceof Uint8Array), 
            N.fromUint8Array(e || new Uint8Array));
        }(t, e.targetChange.resumeToken), o = e.targetChange.cause, c = o && function(t) {
            const e = void 0 === t.code ? O.UNKNOWN : cn(t.code);
 ...
 */ (o);
        ...
        }), c = new Nt(i, r, o, {}), a = s.targetIds || [], u = s.removedTargetIds || [];
        n = new Sn(a, u, c.key, c);
    } else if ("documentDelete" in e) {
        e.documentDelete;
        const s = e.documentDelete;
        s.document;
        const i = jn(t, s.document), r = s.readTime ? Un(s.readTime) : J.min(), o = new Ot(i, r), c = s.removedTargetIds || [];
        n = new Sn([], c, o.key, o);
...
function es(t, e) {
    ...
    return e.fieldTransforms.length > 0 && (n.updateTransforms = e.fieldTransforms.map((t => function(t, e) {
        ...
        throw V();
    }(0, t)))), e.Gt.jt || (n.currentDocument = function(t, e) {
...
function ns(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Be.updateTime(Un(t.updateTime)) : void 0 !== t.exists ? Be.exists(t.exists) : Be.Wt();
    }(e.currentDocument) : Be.Wt(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
        if ("setToServerValue" in e) p("REQUEST_TIME" === e.setToServerValue), n = new Se; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new De(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new xe(t);
        } else "increment" in e ? n = new Oe(t, e.increment) : V();
        const s = tt._t(e.fieldPath);
        return new Me(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
...
function rs(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Gn(t, s), n.structuredQuery.from = [ {
        ...
        allDescendants: !0
    } ]) : (n.parent = Gn(t, s.Z()), n.structuredQuery.from = [ {
        collectionId: s.et()
    } ]);
    const i = function(t) {
...
function as(t) {
    return t ? void 0 !== t.unaryFilter ? [ Es(t) ] : void 0 !== t.fieldFilter ? [ ws(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => as(t))).reduce(((t, e) => t.concat(e))) : V() : [];
}
 ...
 */ class As {
    ...
    next(t, e) {
        return this.On && V(), this.On = !0, this.Nn ? this.error ? this.Fn(e, this.error) : this.kn(t, this.result) : new As(((n, s) => {
            this.Cn = e => {
    ...
    kn(t, e) {
        return t ? this.Ln((() => t(e))) : As.resolve(e);
    }
    Fn(t, e) {
        return t ? this.Ln((() => t(e))) : As.reject(e);
    }
    static resolve(t) {
        return new As(((e, n) => {
            e(t);
...
class Rs {
    constructor(t, e) {
         ...
         */
        this.qn = new ms, this.transaction.oncomplete = () => {
            this.qn.resolve();
        }, this.transaction.onabort = () => {
            e.error ? this.qn.reject(new gs(t, e.error)) : this.qn.resolve();
        }, this.transaction.onerror = e => {
            const n = Ss(e.target.error);
            this.qn.reject(new gs(t, n));
        };
    }
    static open(t, e, n, s) {
        try {
    ...
    abort(t) {
        t && this.qn.reject(t), this.aborted || (R("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class Ps {
     ...
     */
    constructor(t, n, s) {
        this.name = t, this.version = n, this.Qn = s;
        // NOTE: According to https://bugs.webkit.org/show_bug.cgi?id=197050, the
        // bug we're checking for should exist in iOS >= 12.2 and < 13, but for
        // whatever reason it's much harder to hit after 12.2 so we only proactively
        // log on 12.2.
        12.2 === Ps.Kn(e()) && P("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return R("SimpleDb", "Removing database:", t), bs(window.indexedDB.deleteDatabase(t)).Mn();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static Wn() {
        ...
        // Check the UA string to find out the browser.
                const t = e(), n = Ps.Kn(t), s = 0 < n && n < 10, i = Ps.Gn(t), r = 0 < i && i < 4.5;
        // IE 10
     ...
     */    async Jn(t) {
        return this.db || (R("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new F(O.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new gs(t, s));
            }, s.onupgradeneeded = t => {
 ...
 */ class ys {
     ...
     */    delete() {
        return bs(this.ts.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class gs extends F {
    constructor(t, e) {
        super(O.UNAVAILABLE, `IndexedDB transaction '${t}' failed: ${e}`), this.name = "IndexedDbTransactionError";
    }
}
...
class Ds {
    constructor(t, e, n, s, i) {
        this.fs = t, this.ds = e, this.ws = n, this.op = s, this.Es = i, this.Ts = new ms, 
     ...
     */    cancel(t) {
        null !== this.As && (this.clearTimeout(), this.Ts.reject(new F(O.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    Rs() {
 ...
 */ function Cs(t, e) {
    if (P("AsyncQueue", `${e}: ${t}`), Vs(t)) return new F(O.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ function Ms(t) {
    ...
    const e = t.length;
    if (p(e >= 2), 2 === e) return p("" === t.charAt(0) && "" === t.charAt(1)), X.at();
...
// Visible for testing
const ti = [ ...[ ...[ ...[ ...[ Bs.store, qs.store, Us.store, Ws.store, Gs.store, $s.store, Hs.store, zs.store ], Ys.store ], js.store ], Js.store ], Xs.store, Zs.store ];
 ...
 */ class si {
     ...
     */    xs(t, e) {
        ...
        for (const n of this.baseMutations) n.key.isEqual(t) && (e = Ke(n, e, 0, this.Ss));
        // Second, apply all user-provided mutations.
        for (const n of this.mutations) n.key.isEqual(t) && (e = Ke(n, e, 0, this.Ss));
        return e;
    }
    /**
    ...
    isEqual(t) {
        return this.batchId === t.batchId && C(this.mutations, t.mutations, ((t, e) => je(t, e))) && C(this.baseMutations, t.baseMutations, ((t, e) => je(t, e)));
    }
}
...
/** Decodes a remote document from storage locally to a Document. */ function oi(t, e) {
    if (e.document) return Xn(t.ks, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        const t = et.Tt(e.noDocument.path), n = li(e.noDocument.readTime);
        return new Ot(t, n, {
            hasCommittedMutations: !!e.hasCommittedMutations
        });
    }
    if (e.unknownDocument) {
        const t = et.Tt(e.unknownDocument.path), n = li(e.unknownDocument.version);
        return new Ft(t, n);
    }
    return V();
}
...
/** Encodes a document for storage locally. */ function ci(t, e, n) {
    const s = ai(n), i = e.key.path.Z().rt();
    if (e instanceof Nt) {
        const n = function(t, e) {
            return {
                name: Wn(t, e.key),
                fields: e.vt().mapValue.fields,
                updateTime: $n(t, e.version.G())
            };
    ...
    if (e instanceof Ot) {
        const t = e.key.path.rt(), n = hi(e.version), r = e.hasCommittedMutations;
        return new Ws(
        /* unknownDocument= */ null, new Qs(t, n), 
        /* document= */ null, r, s, i);
    }
    if (e instanceof Ft) {
        const t = e.key.path.rt(), n = hi(e.version);
        return new Ws(new Ks(t, n), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function hi(t) {
    const e = t.G();
    return new Ls(e.seconds, e.nanoseconds);
}
...
function _i(t, e) {
    const n = (e.baseMutations || []).map((e => ns(t.ks, e)));
    ...
    const s = e.mutations.map((e => ns(t.ks, e))), i = H.fromMillis(e.localWriteTimeMs);
    return new si(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function fi(t) {
    const e = li(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? li(t.lastLimboFreeSnapshotVersion) : J.min();
    let s;
    var i;
    return void 0 !== t.query.documents ? (p(1 === (i = t.query).documents.length), 
    s = fe(oe(zn(i.documents[0])))) : s = function(t) {
        return fe(os(t));
    }(t.query), new Re(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, N.fromBase64String(t.resumeToken));
}

/** Encodes TargetData into a DbTarget for storage locally. */ function di(t, e) {
    const n = hi(e.Mt), s = hi(e.lastLimboFreeSnapshotVersion);
    let i;
    i = qt(e.target) ? is(t.ks, e.target) : rs(t.ks, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
        const r = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new Gs(e.targetId, Lt(e.target), n, r, e.sequenceNumber, s, i);
}
 ...
 */ class mi {
    ...
    Us(t, e) {
        return this.qs.add(e), As.resolve();
    }
    Qs(t, e) {
        return As.resolve(this.qs.getEntries(e));
    }
}
 ...
 */ class Ai {
    ...
    add(t) {
        const e = t.et(), n = t.Z(), s = this.index[e] || new ln(X.J), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new ln(X.J)).rt();
    }
}
 ...
 */
async function Vi(t) {
    if (t.code !== O.FAILED_PRECONDITION || t.message !== xs) throw t;
 ...
 */ gi.Zs = 10, gi.ti = 1e3, gi.ei = new gi(41943040, gi.Zs, gi.ti), gi.ni = new gi(-1, 0, 0);
 ...
 */ class bi {
    constructor() {
        ...
        this.oi = new pi((t => t.toString()), ((t, e) => t.isEqual(e))), this.ci = !1;
    }
    ai(t) {
     ...
     */    fi(t, e) {
        ...
        return void 0 !== n ? As.resolve(n.li) : this.di(t, e);
    }
    /**
...
/** A mutation queue for a specific user, backed by IndexedDB. */ class Di {
    ...
    Pi(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            ...
            const c = new si(o, e, n, s), a = function(t, e, n) {
                const s = n.baseMutations.map((e => es(t.ks, e))), i = n.mutations.map((e => es(t.ks, e)));
                return new qs(e, n.batchId, n.Ss.toMillis(), s, i);
            }(this.Kt, this.userId, c), u = [];
            let h = new ln(((t, e) => D(t.ot(), e.ot())));
            for (const t of s) {
                const e = Us.key(this.userId, t.key.path, o);
                h = h.add(t.key.path.Z()), u.push(r.put(a)), u.push(i.put(e, Us.PLACEHOLDER));
            }
            return h.forEach((e => {
    ...
    yi(t, e) {
        return xi(t).get(e).next((t => t ? (p(t.userId === this.userId), _i(this.Kt, t)) : null));
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    gi(t, e) {
        return this.mi[e] ? As.resolve(this.mi[e]) : this.yi(t, e).next((t => {
            if (t) {
                const n = t.keys();
    ...
    Vi(t, e) {
        ...
        return xi(t).ls({
            ...
            e.userId === this.userId && (p(e.batchId >= n), i = _i(this.Kt, e)), s.done();
        })).next((() => i));
    }
    pi(t) {
    ...
    bi(t) {
        ...
        return xi(t).os(qs.userMutationsIndex, e).next((t => t.map((t => _i(this.Kt, t)))));
    }
    vi(t, e) {
        ...
        return Ni(t).ls({
            ...
            return xi(t).get(a).next((t => {
                if (!t) throw V();
                p(t.userId === this.userId), i.push(_i(this.Kt, t));
            }));
            r.done();
        })).next((() => i));
    }
    Si(t, e) {
        ...
        const s = [];
        return e.forEach((e => {
            const i = Us.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = Ni(t).ls({
                range: r
            }, ((t, s, i) => {
    ...
    Di(t, e) {
        ...
        return e.forEach((e => {
            s.push(xi(t).get(e).next((t => {
                if (null === t) throw V();
                p(t.userId === this.userId), n.push(_i(this.Kt, t));
            })));
        })), As.$n(s).next((() => n));
    }
    xi(t, e) {
        return vi(t.bs, this.userId, e).next((n => (t.Vs((() => {
            this.Ni(e.batchId);
        })), As.forEach(n, (e => this.Ii.Oi(t, e))))));
    }
    /**
    ...
    Mi(t) {
        return Oi(t).get(this.userId).next((t => t || new Bs(this.userId, -1, 
        /*lastStreamToken=*/ "")));
    }
}
 ...
 */ class ki {
    ...
    Ki(t) {
        return this.Ui(t).next((t => J.W(new H(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
    }
    Wi(t) {
    ...
    Yi(t, e) {
        return this.Xi(t, e.targetId).next((() => Mi(t).delete(e.targetId))).next((() => this.Ui(t))).next((e => (p(e.targetCount > 0), 
    ...
    Ui(t) {
        return Li(t).get(Hs.key).next((t => (p(null !== t), t)));
    }
    Qi(t, e) {
        return Li(t).put(Hs.key, e);
    }
    zi(t, e) {
        return Mi(t).put(di(this.Kt, e));
    }
    /**
    ...
    er(t, e) {
        ...
        const n = Lt(e), s = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]);
        let i = null;
        return Mi(t).ls({
            range: s,
    ...
    nr(t, e, n) {
        ...
        return e.forEach((e => {
            const r = Os(e.path);
            s.push(i.put(new zs(n, r))), s.push(this.Ii.sr(t, n, e));
        })), As.$n(s);
    }
    ir(t, e, n) {
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        ...
        return As.forEach(e, (e => {
            const i = Os(e.path);
            return As.$n([ s.delete([ n, i ]), this.Ii.rr(t, n, e) ]);
        }));
    }
    Xi(t, e) {
    ...
    cr(t, e) {
        ...
        return s.ls({
            ...
            const s = Ms(t[1]), r = new et(s);
            i = i.add(r);
        })).next((() => i));
    }
    ki(t, e) {
        const n = Os(e.path), s = IDBKeyRange.bound([ n ], [ x(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return $i(t).ls({
 ...
 */ class qi {
    constructor(t) {
        this.ar = t, this.buffer = new ln(Bi), this.ur = 0;
    }
    hr() {
        return ++this.ur;
    }
 ...
 */ class Ui {
    ...
    Er(t) {
        ...
        R("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.wr = this.fs.Ir("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            this.wr = null, this.dr = !0;
            try {
                await t.mr(this._r);
            } catch (t) {
                Vs(t) ? R("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await Vi(t);
            }
            await this.Er(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Qi {
    ...
    pr(t, e) {
        return -1 === this.params.Hs ? (R("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        As.resolve(yi)) : this.br(t).next((n => n < this.params.Hs ? (R("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ` + this.params.Hs), 
        yi) : this.vr(t, e)));
    }
    br(t) {
        return this.Ar.br(t);
    ...
    vr(t, e) {
        ...
        e > this.params.Ys ? (R("LruGarbageCollector", `Capping sequence numbers to collect down to the maximum of ${this.params.Ys} from ` + e), 
        s = this.params.Ys) : s = e, r = Date.now(), this.yr(t, s)))).next((s => (n = s, 
        o = Date.now(), this.Zi(t, n, e)))).next((e => (i = e, c = Date.now(), this.Vr(t, n)))).next((t => {
...
class Ki {
     ...
     */    Nr(t, e) {
        return function(t, e) {
            let n = !1;
            return Oi(t)._s((s => Ci(t, s, e).next((t => (t && (n = !0), As.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    Vr(t, e) {
        ...
        return this.Cr(t, ((r, o) => {
            if (o <= e) {
                const e = this.Nr(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.fi(t, r).next((() => (n._i(r), $i(t).delete([ 0, Os(r.path) ]))));
                }));
                s.push(e);
            }
        })).next((() => As.$n(s))).next((() => n.apply(t))).next((() => i));
    }
    removeTarget(t, e) {
        const n = e.Lt(t.vs);
 ...
 */ class ji {
     ...
     */    updateMetadata(t, e) {
        ...
        return Hi(t).get(Ji(e)).next((t => this.$r(t)));
    }
    /**
     ...
     */    Ur(t, e) {
        let n = wn(), s = new an(et.J);
        return this.qr(t, e, ((t, e) => {
            const i = this.$r(e);
            i ? (n = n.Ht(t, i), s = s.Ht(t, Si(e))) : (n = n.Ht(t, null), s = s.Ht(t, 0));
        })).next((() => ({
            Qr: n,
            Kr: s
        })));
    ...
    qr(t, e, n) {
        ...
        return Hi(t).ls({
            ...
            // Go through keys not found in cache.
                        for (;r && et.J(r, o) < 0; ) n(r, null), r = i.ce();
            r && r.isEqual(o) && (
            // Key found in cache.
    ...
    Wr(t, e, n) {
        ...
        return Hi(t).ls(r, ((t, n, r) => {
            ...
            const o = oi(this.Kt, n);
            e.path.st(o.key.path) ? o instanceof Nt && Ie(e, o) && (s = s.Ht(o.key, o)) : r.done();
        })).next((() => s));
    }
    Or(t) {
    ...
    getMetadata(t) {
        return zi(t).get(js.key).next((t => (p(!!t), t)));
    }
    Lr(t, e) {
     ...
     */    $r(t) {
        if (t) {
            const e = oi(this.Kt, t);
            return e instanceof Ot && e.version.isEqual(J.min()) ? null : e;
        }
        return null;
    }
}
...
class Gi extends bi {
     ...
     */
    constructor(t, e) {
        super(), this.Gr = t, this.jr = e, 
        // A map of document sizes prior to applying the changes in this buffer.
        this.zr = new pi((t => t.toString()), ((t, e) => t.isEqual(e)));
    }
    Ei(t) {
        const e = [];
        let n = 0, s = new ln(((t, e) => D(t.ot(), e.ot())));
        return this.oi.forEach(((i, r) => {
            const o = this.zr.get(i);
            if (r.li) {
                const c = ci(this.Gr.Kt, r.li, this.ai(i));
                s = s.add(i.path.Z());
                const a = Si(c);
                ...
                const n = ci(this.Gr.Kt, new Ot(i, J.min()), this.ai(i));
                e.push(this.Gr.ui(t, i, n));
            } else e.push(this.Gr._i(t, i));
        })), s.forEach((n => {
            e.push(this.Gr.Ti.Us(t, n));
        })), e.push(this.Gr.updateMetadata(t, n)), As.$n(e);
    }
    di(t, e) {
 ...
 */
        function(t) {
            ...
            /*highestTargetId=*/ 0, 
            /*lastListenSequenceNumber=*/ 0, J.min().G(), 
            /*targetCount=*/ 0);
 ...
 */ (i)))), n < 4 && s >= 4 && (0 !== n && (
        ...
        r = r.next((() => function(t, e) {
            return e.store(qs.store).os().next((n => {
 ...
 */ (t);
    ...
    Jr(t) {
        let e = 0;
        return t.store(Ws.store).ls(((t, n) => {
            e += Si(n);
        })).next((() => {
            const n = new js(e);
    ...
    Hr(t) {
        ...
        return e.os().next((e => As.forEach(e, (e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.os(qs.userMutationsIndex, s).next((n => As.forEach(n, (n => {
                p(n.userId === e.userId);
                const s = _i(this.Kt, n);
     ...
     */    Yr(t) {
        ...
        return t.store(Hs.store).get(Hs.key).next((t => {
            ...
            return n.ls(((n, i) => {
                ...
                s.push(e.get(o).next((n => n ? As.resolve() : (n => e.put(new zs(0, Os(n), t.highestListenSequenceNumber)))(r))));
            })).next((() => As.$n(s)));
        }));
    }
    Xr(t, e) {
        ...
        return e.store(Ws.store).ls({
            hs: !0
        }, ((t, e) => {
            const n = new X(t);
            return i(n.Z());
        })).next((() => e.store(Us.store).ls({
            hs: !0
        }, (([t, e, n], s) => {
            const r = Ms(e);
            return i(r.Z());
...
class tr {
    ...
    u) {
        ...
        this.ho = t => Promise.resolve(), !tr.Wn()) throw new F(O.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.Ii = new Ki(this, s), this.lo = e + "main", this.Kt = new ri(c), this._o = new Ps(this.lo, 11, new Yi(this.Kt)), 
        this.fo = new ki(this.Ii, this.Kt), this.Ti = new Ri, this.wo = function(t, e) {
            return new ji(t, e);
        }
        /**
 ...
 */
        ...
        (this.Kt, this.Ti), this.Eo = new Ei, this.window && this.window.localStorage ? this.To = this.window.localStorage : (this.To = null, 
     ...
     */    start() {
        ...
        return this.Io().then((() => {
            ...
            throw new F(O.FAILED_PRECONDITION, Zi);
            return this.mo(), this.Ao(), this.Ro(), this.runTransaction("getHighestListenSequenceNumber", "readonly", (t => this.fo.Wi(t)));
        })).then((t => {
            this.io = new z(t, this.no);
        })).then((() => {
            this.ro = !0;
    ...
    po(t) {
        return er(t).get($s.key).next((t => As.resolve(this.Co(t))));
    }
    xo(t) {
     ...
     */    vo(t) {
        if (this.so) return As.resolve(!0);
        return er(t).get($s.key).next((e => {
            ...
            return !(!this.networkEnabled || !this.inForeground) || nr(t).os().next((t => void 0 === this.Fo(t, 5e3).find((t => {
    ...
    async Lo() {
        ...
        await this._o.runTransaction("shutdown", "readwrite", [ $s.store, Ys.store ], (t => {
            const e = new ei(t, z.U);
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    Qo() {
        return this.runTransaction("getActiveClients", "readonly", (t => nr(t).os().next((t => this.Fo(t, 18e5).map((t => t.clientId))))));
    }
    get Tr() {
        return this.ro;
    }
    Ko(t) {
        return Di.Ai(t, this.Kt, this.Ti, this.Ii);
    }
    Dr() {
        return this.fo;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this._o.runTransaction(t, s, ti, (s => (i = new ei(s, this.io ? this.io.next() : z.U), 
        "readwrite-primary" === e ? this.po(i).next((t => !!t || this.vo(i))).next((e => {
            ...
            this.eo.bo((() => this.ho(!1))), new F(O.FAILED_PRECONDITION, xs);
            return n(i);
    ...
    // be turned off.
    Go(t) {
        return er(t).get($s.key).next((t => {
            if (null !== t && this.Oo(t.leaseTimestampMs, 5e3) && !this.Mo(t.ownerId) && !this.Co(t) && !(this.so || this.allowTabSynchronization && t.allowTabSynchronization)) throw new F(O.FAILED_PRECONDITION, Zi);
        }));
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    So(t) {
        const e = er(t);
        return e.get($s.key).next((t => this.Co(t) ? (R("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete($s.key)) : As.resolve()));
    }
 ...
 */
    ...
    ec(t, e) {
        ...
        return this.Jo(t, new et(e)).next((t => {
            let e = Tn();
            return t instanceof Nt && (e = e.Ht(t.key, t)), e;
        }));
    }
    nc(t, e, n) {
        const s = e.collectionGroup;
        let i = Tn();
        return this.Ti.Qs(t, s).next((r => As.forEach(r, (r => {
            const o = function(t, e) {
                return new ie(e, 
 ...
 */ (e, r.child(s));
    ...
    sc(t, e, n) {
        ...
        let s, i;
        return this.wo.Wr(t, e, n).next((n => (s = n, this.Ho.Ci(t, e)))).next((e => (i = e, 
        this.ic(t, i, s).next((t => {
            s = t;
            for (const t of i) for (const e of t.mutations) {
                const n = e.key, i = s.get(n), r = Ke(e, i, 0, t.Ss);
                s = r instanceof Nt ? s.Ht(n, r) : s.remove(n);
            }
        }))))).next((() => (
    ...
    ic(t, e, n) {
        ...
        return this.wo.getEntries(t, s).next((t => (t.forEach(((t, e) => {
            null !== e && e instanceof Nt && (i = i.Ht(t, e));
        })), i)));
    }
}
 ...
 */ class cr {
    ...
    /** Returns all local documents matching the specified query. */    Wr(t, e, n, s) {
        ...
        }(e) || n.isEqual(J.min()) ? this.hc(t, e) : this.uc.Zo(t, s).next((i => {
            const r = this.lc(e, i);
            return (ce(e) || ae(e)) && this._c(e.limitType, r, s, n) ? this.hc(t, e) : (A() <= u.DEBUG && R("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Te(e)), 
            this.uc.Wr(t, e, n).next((t => (
    ...
    /** Applies the query filter and sorting to the provided documents.  */    lc(t, e) {
        ...
        let n = new ln(me(t));
        return e.forEach(((e, s) => {
            s instanceof Nt && Ie(t, s) && (n = n.add(s));
        })), n;
    }
    /**
    ...
    hc(t, e) {
        return A() <= u.DEBUG && R("QueryEngine", "Using full collection scan to execute query:", Te(e)), 
        this.uc.Wr(t, e, J.min());
    }
}
...
class ar {
    ...
    t, e, n, s) {
        ...
        this.wc = new pi((t => Lt(t)), Bt), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.Ec = J.min(), this.Ho = t.Ko(n), this.Tc = t.Fr(), this.fo = t.Dr(), this.Ic = new rr(this.Tc, this.Ho, this.persistence.Wo()), 
...
async function hr(t, e) {
    ...
    const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
        ...
        // MutationQueue.
        i = new rr(n.Tc, s, n.persistence.Wo()), s.bi(t)))).next((e => {
            const n = [], s = [];
        ...
        return function(t, e, n, s) {
            ...
            return r.forEach((t => {
                o = o.next((() => s.fi(e, t))).next((e => {
                    let r = e;
                    const o = n.Fs.get(t);
                    p(null !== o), (!r || r.version.u(o) < 0) && (r = i.Ds(t, r, n), r && 
 ...
 */ (c, u, e) && o.push(n.fo.Ji(t, u));
        ...
        o.push(dr(t, r, e.Me, s, void 0).next((t => {
            c = t;
        }))), !s.isEqual(J.min())) {
            const e = n.fo.Ki(t).next((e => n.fo.ji(t, t.vs, s)));
            o.push(e);
        }
        return As.$n(o).next((() => r.apply(t))).next((() => n.Ic.tc(t, c)));
    })).then((t => (n.dc = i, t)));
}
...
i) {
    ...
    return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
        ...
        return n.forEach(((n, o) => {
            ...
            // cache.
            o instanceof Ot && o.version.isEqual(J.min()) ? (
            ...
            r = r.Ht(n, o)) : R("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", c.version, " Watch version:", o.version);
        })), r;
    }));
}
...
function Er(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, As.resolve(s)) : n.fo.qi(t).next((i => (s = new Re(e, i, 0 /* Listen */ , t.vs), 
        n.fo.Gi(t, s).next((() => s)))))));
    })).then((t => {
...
async function Tr(t, e, n) {
    const s = b(t), i = s.dc.get(e), r = n ? "readwrite" : "readwrite-primary";
    try {
 ...
 */ function Ir(t, e, n) {
    ...
    return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
        const s = b(t), i = s.wc.get(n);
        return void 0 !== i ? As.resolve(s.dc.get(i)) : s.fo.er(e, n);
    }(s, t, fe(e)).next((e => {
        if (e) return i = e.lastLimboFreeSnapshotVersion, s.fo.cr(t, e.targetId).next((t => {
            r = t;
        }));
    })).next((() => s.fc.Wr(t, e, n ? i : J.min(), n ? r : Rn()))).next((t => ({
        documents: t,
        Pc: r
    })))));
}
...
// PORTING NOTE: Multi-Tab only.
function mr(t, e) {
    const n = b(t), s = b(n.fo), i = n.dc.get(e);
...
async function Pr(t, e, n, s) {
    ...
    const a = i.Tc.Or({
        ...
        return fe(oe(X.ct("__bundle__/docs/" + t)));
    }(s));
    // Allocates a target to hold all document keys from the bundle, such that
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => dr(t, a, o, J.min(), c).next((e => (a.apply(t), 
 ...
 */
async function yr(t, e, n = Rn()) {
    // Allocate a target for the named query such that it can be resumed
    // from associated read time if users use it to listen.
    // NOTE: this also means if no corresponding target exists, the new target
    // will remain active and will not get collected, unless users happen to
    // unlisten the query somehow.
    const s = await Er(t, fe(wi(e.bundledQuery))), i = b(t);
 ...
 */ class gr {
    ...
    Ms(t, e) {
        return As.resolve(this.bc.get(e));
    }
    Ls(t, e) {
    ...
    $s(t, e) {
        return As.resolve(this.vc.get(e));
    }
    Bs(t, e) {
 ...
 */ class Vr {
     ...
     * removed.
     */    kc(t) {
        const e = new et(new X([])), n = new pr(e, t), s = new pr(e, t + 1), i = [];
    ...
    Lc(t) {
        const e = new et(new X([])), n = new pr(e, t), s = new pr(e, t + 1);
        let i = Rn();
        return this.Cc.Ae([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
    ...
    ki(t) {
        const e = new pr(t, 0), n = this.Sc.Pe(e);
...
class pr {
    ...
    /** Compare by key then by ID */    static Dc(t, e) {
        return et.J(t.key, e.key) || D(t.$c, e.$c);
    }
    /** Compare by ID then by key */    static xc(t, e) {
        return D(t.$c, e.$c) || et.J(t.key, e.key);
    }
}
 ...
 */ class br {
    constructor(t, e) {
        ...
        this.qc = new ln(pr.Dc);
    }
    Ri(t) {
        return As.resolve(0 === this.Ho.length);
    }
    Pi(t, e, n, s) {
        const i = this.Bc;
        ...
        for (const e of s) this.qc = this.qc.add(new pr(e.key, i)), this.Ti.Us(t, e.key.path.Z());
        return As.resolve(r);
    }
    yi(t, e) {
        return As.resolve(this.Uc(e));
    }
    Vi(t, e) {
        const n = e + 1, s = this.Qc(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return As.resolve(this.Ho.length > i ? this.Ho[i] : null);
    }
    pi() {
        return As.resolve(0 === this.Ho.length ? -1 : this.Bc - 1);
    }
    bi(t) {
        return As.resolve(this.Ho.slice());
    }
    vi(t, e) {
    ...
    xi(t, e) {
        p(0 === this.Wc(e.batchId, "removed")), this.Ho.shift();
        let n = this.qc;
    ...
    ki(t, e) {
        const n = new pr(e, 0), s = this.qc.Pe(n);
        return As.resolve(e.isEqual(s && s.key));
    }
    Fi(t) {
        return this.Ho.length, As.resolve();
    }
    /**
...
class vr {
     ...
     */    ui(t, e, n) {
        const s = e.key, i = this.docs.get(s), r = i ? i.size : 0, o = this.jc(e);
    ...
    Wr(t, e, n) {
        ...
        // the documents we need to match the query against.
                const i = new et(e.path.child("")), r = this.docs.ne(i);
        for (;r.ae(); ) {
            const {key: t, value: {li: i, readTime: o}} = r.ce();
            if (!e.path.st(t.path)) break;
            o.u(n) <= 0 || i instanceof Nt && Ie(e, i) && (s = s.Ht(i.key, i));
        }
        return As.resolve(s);
    }
    Gc(t, e) {
 ...
 */ class Dr {
    constructor(t) {
         ...
         * IDs.
         */
        this.Jc = new Vr, this.targetCount = 0, this.Yc = Fi.$i();
    }
    mn(t, e) {
        return this.zc.forEach(((t, n) => e(n))), As.resolve();
    }
    Ki(t) {
        return As.resolve(this.lastRemoteSnapshotVersion);
    }
    Wi(t) {
        return As.resolve(this.Hc);
    }
    qi(t) {
        return this.highestTargetId = this.Yc.next(), As.resolve(this.highestTargetId);
    }
    ji(t, e, n) {
    ...
    zi(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.Yc = new Fi(e), this.highestTargetId = e), t.sequenceNumber > this.Hc && (this.Hc = t.sequenceNumber);
    }
    Gi(t, e) {
        return this.zi(e), this.targetCount += 1, As.resolve();
    }
    Ji(t, e) {
        return this.zi(e), As.resolve();
    }
    Yi(t, e) {
    ...
    nr(t, e, n) {
        return this.Jc.Nc(e, n), As.resolve();
    }
    ir(t, e, n) {
        this.Jc.Fc(e, n);
    ...
    Xi(t, e) {
        return this.Jc.kc(e), As.resolve();
    }
    cr(t, e) {
    ...
    ki(t, e) {
        return As.resolve(this.Jc.ki(e));
    }
}
...
class Cr {
     ...
     */
    constructor(t, e) {
        this.Xc = {}, this.io = new z(0), this.ro = !1, this.ro = !0, this.Ii = t(this), 
        this.fo = new Dr(this);
        this.Ti = new mi, this.wo = function(t, e) {
            return new vr(t, e);
        }(this.Ti, (t => this.Ii.Zc(t))), this.Kt = new ri(e), this.Eo = new gr(this.Kt);
    }
    start() {
    ...
    Ko(t) {
        let e = this.Xc[t.R()];
        return e || (e = new br(this.Ti, this.Ii), this.Xc[t.R()] = e), e;
    }
    Dr() {
        return this.fo;
    }
    ...
    runTransaction(t, e, n) {
        ...
        const s = new xr(this.io.next());
        return this.Ii.ta(), n(s).next((t => this.Ii.ea(s).next((() => t)))).Mn().then((t => (s.ps(), 
        t)));
    }
    na(t, e) {
        return As.Bn(Object.values(this.Xc).map((n => () => n.ki(t, e))));
    }
}
...
class Nr {
    ...
    sr(t, e, n) {
        return this.sa.sr(n, e), this.oa.delete(n.toString()), As.resolve();
    }
    rr(t, e, n) {
        return this.sa.rr(n, e), this.oa.add(n.toString()), As.resolve();
    }
    Oi(t, e) {
        return this.oa.add(e.toString()), As.resolve();
    }
    removeTarget(t, e) {
    ...
    ca(t, e) {
        return As.Bn([ () => As.resolve(this.sa.ki(e)), () => this.persistence.Dr().ki(t, e), () => this.persistence.na(t, e) ]);
    }
}
...
class Mr {
     ...
     */    static aa(t, e, n) {
        ...
        i && (r = new F(s.error.code, s.error.message))), i ? new Mr(t, e, s.state, r) : (P("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    ua() {
        const t = {
...
class Lr {
     ...
     */    static aa(t, e) {
        ...
        s && (i = new F(n.error.code, n.error.message))), s ? new Lr(t, n.state, i) : (P("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    ua() {
        const t = {
 ...
 */ class Br {
     ...
     */    static aa(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Br(e.clientId, e.onlineState) : (P("SharedClientState", "Failed to parse online state: " + t), 
        null);
    }
}
 ...
 */ class Ur {
    constructor(t, e, n, s, i) {
        ...
        this.da = null, this.L = null, this.wa = this.Ea.bind(this), this.Ta = new an(D), 
        this.Tr = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.ma = Or(this.persistenceKey, this._a), 
        this.Aa = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.Ta = this.Ta.Ht(this._a, new qr), this.Ra = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    static Wn(t) {
    ...
    Ea(t) {
        ...
        if (e.storageArea === this.storage) {
            if (R("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.ma) return void P("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.eo.bo((async () => {
                if (this.Tr) {
 ...
 */ (e.newValue);
    ...
    Na(t, e, n) {
        const s = new Mr(this.currentUser, t, e, n), i = Fr(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.ua());
    }
    Fa(t) {
    ...
    Ua(t, e, n) {
        const s = kr(this.persistenceKey, t), i = new Lr(t, e, n);
        this.setItem(s, i.ua());
    }
    Ga() {
...
class Qr {
    constructor() {
        this.ru = new qr, this.ou = {}, this.da = null, this.L = null;
    }
    xa(t) {
        // No op.
    }
    ...
    start() {
        return this.ru = new qr, Promise.resolve();
    }
    Qa(t, e, n) {
        // No op.
    }
...
class {
    ...
    bu(t, e, n, s) {
        ...
        const r = {};
        return this.Su(r, s), this.Du(t, i, r, n).then((t => (R("RestConnection", "Received: ", t), 
        t)), (e => {
            ...
            o.listenOnce(l.COMPLETE, (() => {
                try {
                    switch (o.getLastErrorCode()) {
                      ...
                      case _.TIMEOUT:
                        R("Connection", 'RPC "' + t + '" timed out'), r(new F(O.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case _.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (t && t.status && t.message) {
                                ...
                                r(new F(e, t.message));
                            } else r(new F(O.UNKNOWN, "Server responded with status " + o.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        r(new F(O.UNAVAILABLE, "Connection failed."));
                        break;
    ...
    xu(t, e) {
        const a = [ this.Vu, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], u = f(), h = d(), l = {
        ...
        // enough the code is exception free.
            ...
            A || (A = !0, R("Connection", "WebChannel transport closed"), P.Pu());
        })), g(I, w.EventType.ERROR, (t => {
            A || (A = !0, y("Connection", "WebChannel transport errored:", t), P.Pu(new F(O.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    A = !0, P.Pu(new F(e, n)), I.close();
                } else R("Connection", "WebChannel received:", n), P.yu(n);
            }
        })), g(h, E.STAT_EVENT, (t => {
...
class Xr {
     ...
     */    Bu(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && R("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.ku} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
...
class Zr {
    constructor(t, e, n, s, i, r) {
        this.eo = t, this.Qu = n, this.Ku = s, this.Wu = i, this.listener = r, this.state = 0 /* Initial */ , 
        /**
         * A close count that's incremented every time the stream is closed; used by
         * getCloseGuardedDispatcher() to invalidate callbacks that happen after
         * close.
         */
        this.ju = 0, this.Gu = null, this.stream = null, this.zu = new Xr(t, e);
    }
    /**
    ...
    auth() {
        ...
        const t = this.ih(this.ju), e = this.ju;
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                this.Wu.getToken().then((t => {
            ...
            t((() => {
                const t = new F(O.UNKNOWN, "Fetching auth token failed: " + e.message);
                return this.oh(t);
            }));
        }));
    }
    rh(t) {
        const e = this.ih(this.ju);
     ...
     */    ih(t) {
        return e => {
            this.eo.ys((() => this.ju === t ? e() : (R("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
 ...
 */ class to extends Zr {
    ...
    onMessage(t) {
        ...
        this.zu.reset();
        const e = ts(this.Kt, t), n = function(t) {
            // We have only reached a consistent snapshot for the entire stream if there
            // is a read_time set and it applies to all targets (i.e. the list of
            // targets is empty). The backend is guaranteed to send such responses.
            if (!("targetChange" in t)) return J.min();
            const e = t.targetChange;
            return e.targetIds && e.targetIds.length ? J.min() : e.readTime ? Un(e.readTime) : J.min();
        }(t);
     ...
     */    hh(t) {
        ...
        e.database = Hn(this.Kt), e.addTarget = function(t, e) {
            ...
            return n = qt(s) ? {
                ...
                query: rs(t, s)
            }, n.targetId = e.targetId, e.resumeToken.o() > 0 ? n.resumeToken = Bn(t, e.resumeToken) : e.Mt.u(J.min()) > 0 && (
            // TODO(wuandy): Consider removing above check because it is most likely true.
            // Right now, many tests depend on this behaviour though (leaving min() out
            // of serialization).
            n.readTime = $n(t, e.Mt.G())), n;
        }(this.Kt, t);
        const n = cs(this.Kt, t);
 ...
 */ class eo extends Zr {
    ...
    onMessage(t) {
        ...
        p(!!t.streamToken), this.lastStreamToken = t.streamToken, this._h) {
        ...
        return p(!t.writeResults || 0 === t.writeResults.length), this._h = !0, this.listener.Eh();
    }
    /**
...
class no extends class {} {
    ...
    mh() {
        if (this.Ih) throw new F(O.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Gets an auth token and invokes the provided RPC. */    bu(t, e, n) {
        return this.mh(), this.credentials.getToken().then((s => this.Ku.bu(t, e, n, s))).catch((t => {
            throw t.code === O.UNAUTHENTICATED && this.credentials.v(), t;
        }));
    }
...
class so {
    ...
    Vh(t) {
        ...
        this.Ph ? (P(e), this.Ph = !1) : R("OnlineStateTracker", e);
    }
    bh() {
    ...
    e, n, s, i) {
        ...
        this.Fh = [], this.kh = i, this.kh.cu((t => {
            n.ys((async () => {
                ...
                // down our streams.
                fo(this) && (R("RemoteStore", "Restarting streams for network reachability change."), 
                await async function(t) {
                    const e = b(t);
                    e.Oh.add(4 /* ConnectivityChange */), await oo(e), e.Mh.set("Unknown" /* Unknown */), 
                    e.Oh.delete(4 /* ConnectivityChange */), await ro(e);
                }(this));
            }));
        })), this.Mh = new so(n, s);
    }
...
async function ro(t) {
    if (fo(t)) for (const e of t.Fh) await e(/* enabled= */ !0);
}
 ...
 */ function ao(t, e) {
    const n = b(t), s = Co(n);
    n.Nh.delete(e), s.Ju() && ho(n, e), 0 === n.Nh.size && (s.Ju() ? s.Zu() : fo(n) && 
 ...
 */ function _o(t) {
    return fo(t) && !Co(t).Hu() && t.Nh.size > 0;
}

function fo(t) {
    return 0 === b(t).Oh.size;
}
...
async function Io(t, e, n) {
    ...
    t.Mh.set("Online" /* Online */), e instanceof Cn && 2 /* Removed */ === e.state && e.cause) 
 ...
 */ (t, e);
        ...
        await mo(t, n);
    } else if (e instanceof Sn ? t.Lh.wn(e) : e instanceof Dn ? t.Lh.yn(e) : t.Lh.In(e), 
    !n.isEqual(J.min())) try {
        const e = await _r(t.Sh);
        n.u(e) >= 0 && 
 ...
 */
        ...
        R("RemoteStore", "Failed to raise snapshot:", e), await mo(t, e);
    }
}
 ...
 */ async function mo(t, e, n) {
    ...
    await oo(t), t.Mh.set("Offline" /* Offline */), n || (
    ...
    t.fs.bo((async () => {
        R("RemoteStore", "Retrying IndexedDB access"), await n(), t.Oh.delete(1 /* IndexedDbFailed */), 
        await ro(t);
    }));
}
...
function go(t) {
    return fo(t) && !xo(t).Hu() && t.xh.length > 0;
}
...
async function vo(t, e, n) {
    const s = t.xh.shift(), i = ii.from(s, e, n);
    await Ao(t, (() => t.Ch.qh(i))), 
...
async function So(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, on(n) && n !== O.ABORTED) {
            ...
            // restart.
                        xo(t).Xu(), await Ao(t, (() => t.Ch.Uh(n.batchId, e))), 
...
async function Do(t, e) {
    const n = b(t);
    e ? (n.Oh.delete(2 /* IsSecondary */), await ro(n)) : e || (n.Oh.add(2 /* IsSecondary */), 
    await oo(n), n.Mh.set("Unknown" /* Unknown */));
}
 ...
 */ (t.Dh, t.fs, {
        ...
        e ? (t.Qh.Xu(), _o(t) ? lo(t) : t.Mh.set("Unknown" /* Unknown */)) : (await t.Qh.stop(), 
        wo(t));
    }))), t.Qh;
}
 ...
 */ function xo(t) {
    ...
    t.Kh = function(t, e, n) {
        const s = b(t);
        return s.mh(), new eo(e, s.Ku, s.credentials, s.Kt, n);
    }(t.Dh, t.fs, {
        Eu: po.bind(null, t),
        Iu: So.bind(null, t),
        Eh: bo.bind(null, t),
        ...
        await Ro(t)) : (await t.Kh.stop(), t.xh.length > 0 && (R("RemoteStore", `Stopping write stream with ${t.xh.length} pending writes`), 
        t.xh = []));
    }))), t.Kh;
}
 ...
 */ class Bo {
     ...
     */    Hh(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new pn(t.query, t.docs, t.De, e, t.Ce, t.fromCache, t.xe, 
    ...
    nl(t) {
        t = pn.Oe(t.query, t.docs, t.Ce, t.fromCache), this.Xh = !0, this.Yh.next(t);
    }
}
 ...
 */ class Uo {
     ...
     */    gc(t) {
        return t.metadata.exists ? Xn(this.Kt, t.document, !1) : new Ot(this.yc(t.metadata.name), this.Vc(t.metadata.readTime));
    }
    Vc(t) {
        return Un(t);
    }
 ...
 */ class Qo {
    ...
    cl(t) {
        const e = new Map, n = new Uo(this.Kt);
     ...
     */    async complete() {
        const t = await Pr(this.Sh, new Uo(this.Kt), this.documents, this.rl.id), e = this.cl(this.documents);
        for (const t of this.queries) await yr(this.Sh, t, e.get(t.name));
 ...
 */ class Go {
    ...
    e) {
        ...
        this.Ce = Rn(), this.ll = me(t), this._l = new gn(this.ll);
    }
    /**
     ...
     */    dl(t, e) {
        const n = e ? e.wl : new Vn, s = e ? e._l : this._l;
 ...
 */ (t.type, e.type) || this.ll(t.doc, e.doc))), this.Tl(n);
        ...
        if (this.ul = o, 0 !== i.length || c) {
            return {
                snapshot: new pn(this.query, t._l, s, i, t.Ce, 0 /* Local */ === o, c, 
                /* excludesMetadataChanges= */ !1),
                ml: r
            };
        }
    ...
    // PORTING NOTE: Multi-tab only.
    Pl() {
        return pn.Oe(this.query, this._l, this.Ce, 0 /* Local */ === this.ul);
    }
}
 ...
 */ class Jo {
    ...
    s, i, r) {
        ...
        this.vl = {}, this.Sl = new pi((t => Ee(t)), we), this.Dl = new Map, 
        /**
         ...
         */
        this.Nl = new Map, this.Ol = new Vr, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Fl = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.kl = new Map, this.Ml = Fi.Bi(), this.onlineState = "Unknown" /* Unknown */ , 
...
async function Yo(t, e) {
    ...
    s = r.targetId, n.pl.ka(s), i = r.view.Pl(); else {
        const t = await Er(n.Sh, fe(e)), r = n.pl.ka(t.targetId);
        s = t.targetId, i = await Xo(n, e, s, "current" === r), n.$l && co(n.gl, t);
    }
    return i;
}
 ...
 */ async function Xo(t, e, n, s) {
    ...
    t.Bl = (e, n, s) => async function(t, e, n, s) {
        ...
        i = await Ir(t.Sh, e.query, 
        /* usePreviousResults= */ !1).then((({documents: t}) => e.view.dl(t, i))));
        const r = s && s.Fe.get(e.targetId), o = e.view.Ei(i, 
        /* updateLimboDocuments= */ t.$l, r);
        return lc(t, e.targetId, o.ml), o.snapshot;
    }(t, e, n, s);
    const i = await Ir(t.Sh, e, 
    /* usePreviousResults= */ !0), r = new Go(e, i.Pc), o = r.dl(i.documents), c = vn.Be(n, s && "Offline" /* Offline */ !== t.onlineState), a = r.Ei(o, 
...
/** Stops listening to the query. */ async function Zo(t, e) {
    const n = b(t), s = n.Sl.get(e), i = n.Dl.get(s.targetId);
    if (i.length > 1) return n.Dl.set(s.targetId, i.filter((t => !we(t, e)))), void n.Sl.delete(e);
    // No other queries are mapped to the target, clean up the query and the target.
        if (n.$l) {
        // We need to remove the local query target first to allow us to verify
        // whether any other client is still interested in this target.
        n.pl.La(s.targetId);
        n.pl.Ca(s.targetId) || await Tr(n.Sh, s.targetId, 
        /*keepPersistedTargetData=*/ !1).then((() => {
            n.pl.Ba(s.targetId), ao(n.gl, s.targetId), uc(n, s.targetId);
        })).catch(Vi);
    } else uc(n, s.targetId), await Tr(n.Sh, s.targetId, 
 ...
 */ async function tc(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = b(t), s = H.now(), i = e.reduce(((t, e) => t.add(e.key)), Rn());
            let r;
 ...
 * it.
 */ (s, t.batchId, n), await dc(s, t.oi), await Ro(s.gl);
    } catch (t) {
 ...
 */ async function ec(t, e) {
    ...
    try {
        ...
        // Update `receivedDocument` as appropriate for any limbo targets.
            ...
            p(t.Ue.size + t.Qe.size + t.Ke.size <= 1), t.Ue.size > 0 ? s.yl = !0 : t.Qe.size > 0 ? p(s.yl) : t.Ke.size > 0 && (p(s.yl), 
            s.yl = !1));
        })), await dc(n, t, e);
    } catch (t) {
        await Vi(t);
 ...
 */ async function sc(t, e, n) {
    ...
    if (r) {
        ...
        let t = new an(et.J);
        t = t.Ht(r, new Ot(r, J.min()));
        const n = Rn().add(r), i = new bn(J.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new ln(D), t, n);
        await ec(s, i), 
        ...
        s.xl = s.xl.remove(r), s.Nl.delete(e), fc(s);
    } else await Tr(s.Sh, e, 
    /* keepPersistedTargetData */ !1).then((() => uc(s, e, n))).catch(Vi);
}

async function ic(t, e) {
    const n = b(t), s = e.batch.batchId;
    try {
        const t = await lr(n.Sh, e);
        // The local store may or may not be able to apply the write result and
        // raise events immediately (depending on whether the watcher is caught
        // up), so we raise user callbacks first so that they consistently happen
        // before listen events.
                ac(n, s, /*error=*/ null), cc(n, s), n.pl.Oa(s, "acknowledged"), await dc(n, t);
    } catch (t) {
        await Vi(t);
    }
}
    ...
    try {
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t => {
                let s;
                return n.Ho.yi(t, e).next((e => (p(null !== e), s = e.keys(), n.Ho.xi(t, e)))).next((() => n.Ho.Fi(t))).next((() => n.Ic.Zo(t, s)));
            }));
        }
        /**
 ...
 */ (s.Sh, e);
        ...
        // listen events.
                ac(s, e, n), cc(s, e), s.pl.Oa(e, "rejected", n), await dc(s, t);
    } catch (n) {
        await Vi(n);
    }
}
 ...
 */ async function oc(t, e) {
    const n = b(t);
    fo(n.gl) || R("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
...
function hc(t, e) {
    ...
    const n = t.xl.get(e);
    null !== n && (ao(t.gl, n), t.xl = t.xl.remove(e), t.Nl.delete(n), fc(t));
}

function lc(t, e, n) {
    for (const s of n) if (s instanceof Wo) t.Ol.sr(s.key, e), _c(t, s); else if (s instanceof jo) {
        R("SyncEngine", "Document no longer in limbo: " + s.key), t.Ol.rr(s.key, e);
        t.Ol.ki(s.key) || 
        // We removed the last reference for this key
        hc(t, s.key);
    } else V();
...
function _c(t, e) {
    const n = e.key;
    t.xl.get(n) || (R("SyncEngine", "New document in limbo: " + n), t.Cl.push(n), fc(t));
}
 ...
 */ function fc(t) {
    for (;t.Cl.length > 0 && t.xl.size < t.bl; ) {
        ...
        t.Nl.set(n, new Ho(e)), t.xl = t.xl.Ht(e, n), co(t.gl, new Re(fe(oe(e.path)), n, 2 /* LimboResolution */ , z.U));
    }
}
...
async function dc(t, e, n) {
    ...
    s.Sl.nt() || (s.Sl.forEach(((t, c) => {
        ...
        const n = b(t);
        try {
            await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t => As.forEach(e, (e => As.forEach(e.rc, (s => n.persistence.Ii.sr(t, e.targetId, s))).next((() => As.forEach(e.oc, (s => n.persistence.Ii.rr(t, e.targetId, s)))))))));
        } catch (t) {
            if (!Vs(t)) throw t;
...
async function wc(t, e) {
    ...
    if (!n.currentUser.isEqual(e)) {
        R("SyncEngine", "User change. New user:", e.R());
        ...
        function(t, e) {
            t.kl.forEach((t => {
                t.forEach((t => {
                    t.reject(new F(O.CANCELLED, e));
                }));
            })), t.kl.clear();
        }(n, "'waitForPendingWrites' promise is rejected due to a user change."), 
        // TODO(b/114226417): Consider calling this only in the primary tab.
        n.pl.Qa(e, t.Ac, t.Rc), await dc(n, t.mc);
    }
}

function Ec(t, e) {
    const n = b(t), s = n.Nl.get(e);
    if (s && s.yl) return Rn().add(s.key);
    {
        let t = Rn();
        const s = n.Dl.get(e);
        if (!s) return t;
 ...
 */ async function Tc(t, e) {
    const n = b(t), s = await Ir(n.Sh, e.query, 
    /* usePreviousResults= */ !0), i = e.view.Rl(s);
    return n.$l && lc(n, e.targetId, i.ml), i;
}
...
async function mc(t, e, n, s) {
    const i = b(t), r = await function(t, e) {
        const n = b(t), s = b(n.Ho);
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.gi(t, e).next((e => e ? n.Ic.Zo(t, e) : As.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.Sh, e);
    null !== r ? ("pending" === n ? 
    ...
    await Ro(i.gl) : "acknowledged" === n || "rejected" === n ? (
...
async function Ac(t, e) {
    ...
    if (pc(n), bc(n), !0 === e && !0 !== n.Ll) {
        ...
        const t = n.pl.Sa(), e = await Rc(n, t.rt());
        n.Ll = !0, await Do(n.gl, !0);
        for (const t of e) co(n.gl, t);
    } else if (!1 === e && !1 !== n.Ll) {
        const t = [];
        let e = Promise.resolve();
        n.Dl.forEach(((s, i) => {
            n.pl.$a(i) ? t.push(i) : e = e.then((() => (uc(n, i), Tr(n.Sh, i, 
            /*keepPersistedTargetData=*/ !0)))), ao(n.gl, i);
        ...
        function(t) {
            ...
            e.Nl.forEach(((t, n) => {
                ao(e.gl, n);
            })), e.Ol.Mc(), e.Nl = new Map, e.xl = new an(et.J);
        }
        /**
...
async function Rc(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await Er(s.Sh, fe(n[0]));
            for (const t of n) {
                const e = s.Sl.get(t), n = await Tc(s, e);
                n.snapshot && r.push(n.snapshot);
            }
        } else {
            // For queries that never executed on this client, we need to
            // allocate the target in LocalStore and initialize a new View.
            const n = await mr(s.Sh, t);
            e = await Er(s.Sh, n), await Xo(s, Pc(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
function yc(t) {
    const e = b(t);
    return b(b(e.Sh).persistence).Qo();
}
...
async function gc(t, e, n, s) {
    ...
    R("SyncEngine", "Ignoring unexpected query state notification."); else if (i.Dl.has(e)) switch (n) {
      case "current":
      case "not-current":
        {
            const t = await Ar(i.Sh), s = bn.$e(e, "current" === n);
            await dc(i, t, s);
            break;
        }
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Vc(t, e, n) {
    const s = pc(t);
    if (s.Ll) {
        for (const t of e) {
            if (s.Dl.has(t)) {
            ...
            const e = await mr(s.Sh, t), n = await Er(s.Sh, e);
...
function pc(t) {
    const e = b(t);
    return e.gl.Ch.Bh = ec.bind(null, e), e.gl.Ch.Sn = Ec.bind(null, e), e.gl.Ch.$h = sc.bind(null, e), 
    e.vl.uh = Mo.bind(null, e.Vl), e.vl.ql = Lo.bind(null, e.Vl), e;
}

function bc(t) {
    const e = b(t);
    return e.gl.Ch.qh = ic.bind(null, e), e.gl.Ch.Uh = rc.bind(null, e), e;
}
 ...
 */ (t.Sh, s), n.Ul(o.progress);
            ...
            y("SyncEngine", "Loading bundle failed with " + t), n.Wl(t);
        }
    }
    /**
 * @license
...
class Sc {
    ...
    async initialize(t) {
        this.Kt = Yr(t.gu.T), this.pl = this.jl(t), this.persistence = this.Gl(t), await this.persistence.start(), 
    ...
    Jl(t) {
        return ur(this.persistence, new cr, t.Yl, this.Kt);
    }
    Gl(t) {
        return new Cr(Nr.ra, this.Kt);
    }
    jl(t) {
        return new Qr;
    }
 ...
 */ class Dc extends Sc {
    ...
    async initialize(t) {
        await super.initialize(t), await Rr(this.Sh), await this.Xl.initialize(this, t), 
        // Enqueue writes from a previous session
        await bc(this.Xl.fa), await Ro(this.Xl.gl);
    }
    Jl(t) {
        return ur(this.persistence, new cr, t.Yl, this.Kt);
    }
    Hl(t) {
        ...
        return new Ui(e, t.fs);
    }
    Gl(t) {
        const e = sr(t.gu.T, t.gu.persistenceKey), n = void 0 !== this.cacheSizeBytes ? gi.Xs(this.cacheSizeBytes) : gi.ei;
        return new tr(this.synchronizeTabs, e, t.clientId, n, t.fs, Hr(), Jr(), this.Kt, this.pl, !!this.forceOwnership);
    }
    jl(t) {
        return new Qr;
    }
 ...
 */ class Cc extends Dc {
    ...
    async initialize(t) {
        ...
        const e = this.Xl.fa;
        this.pl instanceof Ur && (this.pl.fa = {
            nu: mc.bind(null, e),
            su: gc.bind(null, e),
            iu: Vc.bind(null, e),
            Qo: yc.bind(null, e),
        ...
        await this.persistence.Po((async t => {
            await Ac(this.Xl.fa, t), this.zl && (t && !this.zl.Tr ? this.zl.start(this.Sh) : t || this.zl.stop());
        }));
    }
    jl(t) {
        const e = Hr();
        if (!Ur.Wn(e)) throw new F(O.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        const n = sr(t.gu.T, t.gu.persistenceKey);
        return new Ur(e, t.fs, n, t.clientId, t.Yl);
    }
}
 ...
 */ class xc {
    async initialize(t, e) {
        ...
        /* startAsPrimary=*/ !t.synchronizeTabs), this.pl.da = t => nc(this.fa, t, 1 /* SharedClientState */), 
        this.gl.Ch.s_ = wc.bind(null, this.fa), await Do(this.gl, this.fa.$l));
    }
    e_(t) {
        return new Oo;
    }
    Zl(t) {
        const e = Yr(t.gu.T), n = (s = t.gu, new zr(s));
        var s;
    ...
    t_(t) {
        return e = this.Sh, n = this.Dh, s = t.fs, i = t => nc(this.fa, t, 0 /* RemoteStore */), 
        r = Wr.Wn() ? new Wr : new Kr, new io(e, n, s, i, r);
        var e, n, s, i, r;
    ...
    terminate() {
        return async function(t) {
            const e = b(t);
            R("RemoteStore", "RemoteStore shutting down."), e.Oh.add(5 /* Shutdown */), await oo(e), 
            e.kh.Lo(), 
...
class kc {
     ...
     */
    constructor(...t) {
        for (let e = 0; e < t.length; ++e) if (0 === t[e].length) throw new F(O.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.d_ = new tt(t);
    }
    /**
 ...
 * limitations under the License.
 */ function Lc(t, e, n) {
    if (!n) throw new F(O.INVALID_ARGUMENT, `Function ${t}() cannot be called with an empty ${e}.`);
}
...
function $c(t, e) {
    ...
    if (void 0 !== e.mergeFields && void 0 !== e.merge) throw new F(O.INVALID_ARGUMENT, `Invalid options passed to function ${t}(): You cannot specify both "merge" and "mergeFields".`);
    return e;
}
 ...
 */ function Bc(t, e, n, s) {
    if (!0 === e && !0 === s) throw new F(O.INVALID_ARGUMENT, `${t} and ${n} cannot be used together.`);
}
 ...
 */ function qc(t) {
    if (!et.Et(t)) throw new F(O.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function Uc(t) {
    if (et.Et(t)) throw new F(O.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
...
e) {
    ...
    t = t._), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new F(O.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        {
            const n = Qc(t);
            throw new F(O.INVALID_ARGUMENT, `Expected type '${e.name}', but it was: ${n}`);
        }
    }
    return t;
}
...
function Wc(t, e) {
    if (e <= 0) throw new F(O.INVALID_ARGUMENT, `Function ${t}() requires a positive number, but it was: ${e}.`);
}
...
class jc {
    constructor(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new F(O.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = true;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new F(O.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
        Bc("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling);
    }
    isEqual(t) {
...
class zc {
    /** @hideconstructor */
    constructor(t, e) {
        this.w_ = "(lite)", this.E_ = new jc({}), this.T_ = !1, t instanceof q ? (this.I_ = t, 
        this.m_ = new K) : (this.A_ = t, this.I_ = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new F(O.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 */ (t), this.m_ = new W(e));
     ...
     * instance.
     */    get app() {
        if (!this.A_) throw new F(O.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.A_;
    }
    get R_() {
        return this.T_;
    ...
    g_(t) {
        if (this.T_) throw new F(O.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this.E_ = new jc(t), void 0 !== t.credentials && (this.m_ = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new F(O.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
    }
    V_() {
 ...
 */
        return function(t) {
            const e = Gc.get(t);
            e && (R("ComponentProvider", "Removing Datastore"), Gc.delete(t), e.terminate());
...
class Hc {
     ...
     */    get parent() {
        return new Yc(this.firestore, this.v_, this.S_.path.Z());
    }
    /**
 ...
 */ class Yc extends Jc {
     ...
     */    get parent() {
        const t = this.D_.Z();
        return t.nt() ? null : new Hc(this.firestore, 
...
function Xc(t, e, ...n) {
    if (t instanceof M && (t = t._), Lc("collection", "path", e), t instanceof zc) {
        const s = X.ct(e, ...n);
        return Uc(s), new Yc(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof Hc || t instanceof Yc)) throw new F(O.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = X.ct(t.path, ...n).child(X.ct(e));
        return Uc(s), new Yc(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function Zc(t, e) {
    if (t = Kc(t, zc), Lc("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new F(O.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Jc(t, 
    /* converter= */ null, 
    /**
...
function ta(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = S.t()), Lc("doc", "path", e), t instanceof zc) {
        const s = X.ct(e, ...n);
        return qc(s), new Hc(t, 
        /* converter= */ null, new et(s));
    }
    {
        if (!(t instanceof Hc || t instanceof Yc)) throw new F(O.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t.D_.child(X.ct(e, ...n));
        return qc(s), new Hc(t.firestore, t instanceof Yc ? t.v_ : null, new et(s));
    }
}
 ...
 * Firestore database.
 */ function na(t, e) {
    return t instanceof M && (t = t._), e instanceof M && (e = e._), t instanceof Jc && e instanceof Jc && (t.firestore === e.firestore && we(t.C_, e.C_) && t.v_ === e.v_);
}
 ...
 */ class sa {
     ...
     */
    constructor(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new F(O.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new F(O.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.x_ = t, this.N_ = e;
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class ra {
    ...
    O_(t, e) {
        return null !== this.zt ? new He(t, this.data, this.zt, e, this.fieldTransforms) : new ze(t, this.data, e, this.fieldTransforms);
    }
}
...
/** The result of parsing "update" data (i.e. for an updateData call). */ class oa {
    ...
    O_(t, e) {
        return new He(t, this.data, this.zt, e, this.fieldTransforms);
    }
}
...
/** A "context" object passed around while parsing user data. */ class aa {
    ...
    /** Returns a new context with the specified settings overwritten. */    M_(t) {
        return new aa(Object.assign(Object.assign({}, this.settings), t), this.T, this.Kt, this.ignoreUndefinedProperties, this.fieldTransforms, this.zt);
    }
    L_(t) {
        var e;
 ...
 */ class ua {
    constructor(t, e, n) {
        this.T = t, this.ignoreUndefinedProperties = e, this.Kt = n || Yr(t);
    }
...
function ha(t) {
    ...
    return new ua(t.I_, !!e.ignoreUndefinedProperties, n);
}
...
/** Parse document data from a set() call. */ function la(t, e, n, s, i, r = {}) {
    ...
    const c = Pa(s, o);
    let a, u;
    if (r.merge) a = new rt(o.zt), u = o.fieldTransforms; else if (r.mergeFields) {
        const t = [];
        for (const s of r.mergeFields) {
            const i = Va(e, s, n);
            if (!o.contains(i)) throw new F(O.INVALID_ARGUMENT, `Field '${i}' is specified in your field mask but missing from your input data.`);
            Sa(t, i) || t.push(i);
        }
        a = new rt(t), u = o.fieldTransforms.filter((t => a.It(t.field)));
    } else a = null, u = o.fieldTransforms;
    return new ra(new St(c), a, u);
}
...
class wa extends Mc {
    ...
    z_(t) {
        const e = fa(this, t, 
        /*array=*/ !0), n = this.H_.map((t => Ra(t, e))), s = new De(n);
...
class Ea extends Mc {
    ...
    z_(t) {
        const e = fa(this, t, 
        /*array=*/ !0), n = this.H_.map((t => Ra(t, e))), s = new xe(n);
        return new Me(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Ta extends Mc {
    ...
    z_(t) {
        const e = new Oe(t.Kt, ge(t.Kt, this.J_));
...
/** Parse update data from an update() call. */ function Ia(t, e, n, s) {
    ...
    const c = new rt(r);
    return new oa(o.yt(), c, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function ma(t, e, n, s, i, r) {
    const o = t.G_(1 /* Update */ , e, n), c = [ Va(e, s, n) ], a = [ i ];
    if (r.length % 2 != 0) throw new F(O.INVALID_ARGUMENT, `Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);
    ...
    const l = new rt(u);
    return new oa(h.yt(), l, o.fieldTransforms);
}
...
function Pa(t, e) {
    ...
    e.path && e.path.length > 0 && e.zt.push(e.path) : st(t, ((t, s) => {
        const i = Ra(s, e.L_(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function ya(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof H || t instanceof sa || t instanceof k || t instanceof Hc || t instanceof Mc);
}
 ...
 */ function Va(t, e, n) {
    ...
    // FieldPath.
    e instanceof M && (e = e._), e instanceof kc) return e.d_;
...
function va(t, e, n, s, i) {
    ...
    a += ")"), new F(O.INVALID_ARGUMENT, c + t + a);
}
 ...
 */ class Da {
    ...
    async ef(t) {
        if (this.nf(), this.mutations.length > 0) throw new F(O.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const n = b(t), s = Hn(n.Kt) + "/documents", i = {
                documents: e.map((t => Wn(n.Kt, t)))
        ...
        return e.forEach((t => {
            t instanceof Ot || t instanceof Nt ? this.sf(t) : V();
        })), e;
    }
    set(t, e) {
    ...
    delete(t) {
        this.write(new tn(t, this.Gt(t))), this.tf.add(t.toString());
    }
    async commit() {
        ...
        t.forEach(((t, e) => {
            const n = et.ft(e);
            this.mutations.push(new en(n, this.Gt(n)));
        })), await async function(t, e) {
            const n = b(t), s = Hn(n.Kt) + "/documents", i = {
                writes: e.map((t => es(n.Kt, t)))
            };
    ...
    sf(t) {
        let e;
        if (t instanceof Nt) e = t.version; else {
            if (!(t instanceof Ot)) throw V();
        ...
        if (n) {
            ...
            throw new F(O.ABORTED, "Document version changed between two reads.");
     ...
     */    Gt(t) {
        ...
        return !this.tf.has(t.toString()) && e ? Be.updateTime(e) : Be.Wt();
    }
    /**
     ...
     */    rf(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new F(O.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
...
class Ca {
    constructor(t, e, n, s) {
        this.fs = t, this.Dh = e, this.updateFunction = n, this.Ts = s, this.cf = 5, this.zu = new Xr(this.fs, "transaction_retry" /* TransactionRetry */);
    }
    ...
    af() {
        this.zu.Bu((async () => {
            const t = new Da(this.Dh), e = this.uf(t);
            e && e.then((e => {
    ...
    uf(t) {
        try {
            ...
            return !ft(e) && e.catch && e.then ? e : (this.Ts.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
class xa {
     ...
     */
    e, n) {
        this.credentials = t, this.fs = e, this.gu = n, this.user = U.UNAUTHENTICATED, this.clientId = S.t(), 
        this._f = () => {}, this.N = new ms, this.credentials.S((t => {
            R("FirestoreClient", "Received user=", t.uid), this.user = t, this._f(t), this.N.resolve();
        }));
    }
     ...
     */    df() {
        if (this.fs.wf) throw new F(O.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    terminate() {
        this.fs.Ef();
        const t = new ms;
...
async function Na(t, e) {
    t.fs.Af(), R("FirestoreClient", "Initializing OfflineComponentProvider");
...
async function Oa(t, e) {
    ...
    t.ff((n => t.fs.bo((() => async function(t, e) {
        const n = b(t);
        n.fs.Af(), R("RemoteStore", "RemoteStore received new credentials");
        const s = fo(n);
        // Tear down and re-create our network streams. This will ensure we get a
        // fresh auth token for the new user and re-fill the write pipeline with
        // new mutations from the LocalStore (since mutations are per-user).
                n.Oh.add(3 /* CredentialChange */), await oo(n), s && 
...
async function Fa(t) {
    ...
    await Na(t, new Sc)), t.mf;
}

async function ka(t) {
    return t.If || (R("FirestoreClient", "Using default OnlineComponentProvider"), await Oa(t, new xc)), 
    t.If;
}
...
function La(t) {
    return Fa(t).then((t => t.Sh));
}

function $a(t) {
    return ka(t).then((t => t.gl));
}

function Ba(t) {
    return ka(t).then((t => t.fa));
}

async function qa(t) {
    const e = await ka(t), n = e.Vl;
    return n.Gh = Yo.bind(null, e.fa), n.Jh = Zo.bind(null, e.fa), n;
}
...
/** Enables the network connection and re-enqueues all pending operations. */ function Ua(t) {
    return t.fs.enqueue((async () => {
        ...
        return e.Vo(!0), function(t) {
            const e = b(t);
            return e.Oh.delete(0 /* UserDisabled */), ro(e);
        }(n);
    }));
}
...
/** Disables the network connection. Pending operations will not complete. */ function Qa(t) {
    return t.fs.enqueue((async () => {
        ...
        return e.Vo(!1), async function(t) {
            const e = b(t);
            e.Oh.add(0 /* UserDisabled */), await oo(e), 
 ...
 */ function Ka(t, e) {
    ...
    return t.fs.ys((async () => async function(t, e, n) {
        try {
            ...
            s instanceof Nt ? n.resolve(s) : s instanceof Ot ? n.resolve(null) : n.reject(new F(O.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
        } catch (t) {
...
function Wa(t, e, n = {}) {
    ...
    return t.fs.ys((async () => function(t, e, n, s, i) {
        ...
        return Fo(t, o);
    }(await qa(t), t.fs, e, n, s))), s.promise;
}
...
function ja(t, e) {
    ...
    return t.fs.ys((async () => async function(t, e, n) {
        try {
            ...
            /* usePreviousResults= */ !0), i = new Go(e, s.Pc), r = i.dl(s.documents), o = i.Ei(r, 
            /* updateLimboDocuments= */ !1);
    ...
    return t.fs.ys((async () => function(t, e, n, s, i) {
        const r = new Oc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.ys((() => ko(t, o))), n.fromCache && "server" === s.source ? i.reject(new F(O.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Bo(n, r, {
            includeMetadataChanges: !0,
 ...
 */ function Ha(t, e) {
    ...
    return t.fs.ys((async () => {
        const s = await function(t) {
            return ka(t).then((t => t.Dh));
        }(t);
        new Ca(t.fs, s, e, n).run();
    })), n.promise;
}
...
function Ja(t, e, n, s) {
    const i = function(t, e) {
        ...
        return function(t, e) {
            ...
            if (t instanceof Uint8Array) return Nc(t, e);
            if (t instanceof ArrayBuffer) return Nc(new Uint8Array(t), e);
...
class Xa {
    constructor() {
        ...
        this.zu = new Xr(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.vf = () => {
            const t = Jr();
            t && R("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.zu.Uu();
        };
        const t = Jr();
 ...
 */
    ...
    Ir(t, e, n) {
        ...
        const s = Ds.Is(this, t, e, n, (t => this.xf(t)));
...
class tu extends zc {
    /** @hideconstructor */
    constructor(t, e) {
        super(t, e), this.Mf = new Xa, this.w_ = "name" in t ? t.name : "[DEFAULT]";
    }
    b_() {
        return this.Lf || 
...
function su(t, e, n) {
    ...
    return t.fs.enqueue((async () => {
        try {
            await Na(t, n), await Oa(t, e), s.resolve();
        } catch (t) {
            if (!
            /**
 ...
 */
            function(t) {
                if ("FirebaseError" === t.name) return t.code === O.FAILED_PRECONDITION || t.code === O.UNIMPLEMENTED;
...
function iu(t) {
    if (t.R_ && !t.P_) throw new F(O.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    const e = new ms;
    return t.Mf.Tf((async () => {
        try {
            await async function(t) {
                if (!Ps.Wn()) return Promise.resolve();
                const e = t + "main";
                await Ps.delete(e);
 ...
 */ function ru(t) {
    return function(t) {
        const e = new ms;
        return t.fs.ys((async () => oc(await Ba(t), e))), e.promise;
    }(eu(t = Kc(t, tu)));
}
 ...
 */ function ou(t) {
    if (t.R_ || t.P_) throw new F(O.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ class cu {
    $f(t, e = "none") {
        switch (Et(t)) {
          ...
          case 6 /* BlobValue */ :
            return this.Uf(ut(t.bytesValue));
    ...
    Gf(t, e) {
        const n = X.ct(t);
        p(Is(n));
        const s = new q(n.get(1), n.get(3)), i = new et(n.X(5));
        return s.isEqual(e) || 
 ...
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */ function hu(t, e) {
    return "string" == typeof e ? ba(t, e) : e instanceof M ? e._.d_ : e.d_;
}
 ...
 * limitations under the License.
 */ function lu(t) {
    if (ae(t) && 0 === t.Nt.length) throw new F(O.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class du extends _u {
    ...
    Yf(t) {
        const e = ha(t.firestore), n = function(t, e, n, s, i, r, o) {
            let c;
            if (i.ht()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === r || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === r) throw new F(O.INVALID_ARGUMENT, `Invalid Query. You can't perform '${r}' queries on FieldPath.documentId().`);
            ...
            return function(t, e) {
                if (e.xt()) {
                    const n = he(t);
                    if (null !== n && !n.isEqual(e.field)) throw new F(O.INVALID_ARGUMENT, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${e.field.toString()}'`);
                    const s = ue(t);
 ...
 */
                ...
                throw n === e.op ? new F(O.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new F(O.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
            }(t, a), a;
        }(t.C_, "where", e, t.firestore.I_, this.Xf, this.Zf, this.td);
        return new Jc(t.firestore, t.v_, function(t, e) {
            const n = t.filters.concat([ e ]);
            return new ie(t.path, t.collectionGroup, t.Nt.slice(), n, t.limit, t.limitType, t.startAt, t.endAt);
        }(t.C_, n));
    }
}
 ...
 */ class wu extends _u {
    ...
    Yf(t) {
        const e = function(t, e, n) {
            if (null !== t.startAt) throw new F(O.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new F(O.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            const s = new te(e, n);
            return function(t, e) {
                if (null === ue(t)) {
 ...
 */ class Eu extends _u {
    ...
    Yf(t) {
        return new Jc(t.firestore, t.v_, de(t.C_, this.nd, this.sd));
    }
}
 ...
 */ class Tu extends _u {
    ...
    Yf(t) {
        ...
        return new Jc(t.firestore, t.v_, function(t, e) {
            return new ie(t.path, t.collectionGroup, t.Nt.slice(), t.filters.slice(), t.limit, t.limitType, e, t.endAt);
        }(t.C_, e));
    }
}
...
class Iu extends _u {
    ...
    Yf(t) {
        const e = mu(t, this.type, this.rd, this.od);
        return new Jc(t.firestore, t.v_, function(t, e) {
            return new ie(t.path, t.collectionGroup, t.Nt.slice(), t.filters.slice(), t.limit, t.limitType, t.startAt, e);
        }(t.C_, e));
    }
}
...
function mu(t, e, n, s) {
    if (n[0] instanceof M && (n[0] = n[0]._), n[0] instanceof au) return function(t, e, n, s, i) {
        if (!s) throw new F(O.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        const r = [];
        ...
        // results.
                for (const n of _e(t)) if (n.field.ht()) r.push(yt(e, s.key)); else {
            const t = s.field(n.field);
            if (ht(t)) throw new F(O.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
                const t = n.field.ot();
                throw new F(O.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${t}' (used as the orderBy) does not exist.`);
            }
            r.push(t);
        }
        return new Xt(r, i);
 ...
 */ (t.C_, t.firestore.I_, e, n[0].Jf, s);
    {
        ...
        return function(t, e, n, s, i, r) {
            ...
            const o = t.Nt;
            if (i.length > o.length) throw new F(O.INVALID_ARGUMENT, `Too many arguments provided to ${s}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
            const c = [];
            for (let r = 0; r < i.length; r++) {
                const a = i[r];
                if (o[r].field.ht()) {
                    if ("string" != typeof a) throw new F(O.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof a}`);
                    if (!le(t) && -1 !== a.indexOf("/")) throw new F(O.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
                    const n = t.path.child(X.ct(a));
                    if (!et.Et(n)) throw new F(O.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new et(n);
                    c.push(yt(e, i));
                } else {
                    const t = Aa(n, s, a);
...
function Au(t, e, n) {
    if (n instanceof M && (n = n._), "string" == typeof n) {
        if ("" === n) throw new F(O.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!le(e) && -1 !== n.indexOf("/")) throw new F(O.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const s = e.path.child(X.ct(n));
        if (!et.Et(s)) throw new F(O.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return yt(t, new et(s));
    }
    if (n instanceof Hc) return yt(t, n.S_);
    throw new F(O.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Qc(n) + ".");
}
 ...
 * array requirements.
 */ function Ru(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new F(O.INVALID_ARGUMENT, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
    if (t.length > 10) throw new F(O.INVALID_ARGUMENT, `Invalid Query. '${e.toString()}' filters support a maximum of 10 elements in the value array.`);
}

function Pu(t, e, n) {
    if (!n.isEqual(e)) throw new F(O.INVALID_ARGUMENT, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`);
}
 ...
 */ class Su {
     ...
     */    forEach(t, e) {
        this.ud.docs.forEach((n => {
            t.call(e, new vu(this.zf, this.Hf, n.key, n, new pu(this.ud.Ce.has(n.key), this.ud.fromCache), this.query.v_));
        }));
    }
    /**
     ...
     */    docChanges(t = {}) {
        ...
        if (e && this.ud.Ne) throw new F(O.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t.ud.De.nt()) {
                ...
                return t.ud.docChanges.map((s => {
                    const i = new vu(t.zf, t.Hf, s.doc.key, s.doc, new pu(t.ud.Ce.has(s.doc.key), t.ud.fromCache), t.query.v_);
                    return e = s.doc, {
                        type: "added",
                        doc: i,
                        oldIndex: -1,
            ...
            }
            {
                ...
                return t.ud.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new vu(t.zf, t.Hf, e.doc.key, e.doc, new pu(t.ud.Ce.has(e.doc.key), t.ud.fromCache), t.query.v_);
                    let i = -1, r = -1;
 ...
 */ function Nu(t, e, n, ...s) {
    t = Kc(t, Hc);
    const i = Kc(t.firestore, tu), r = ha(i);
    let o;
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e instanceof M && (e = e._), o = "string" == typeof e || e instanceof kc ? ma(r, "updateDoc", t.S_, e, n, s) : Ia(r, "updateDoc", t.S_, e);
    return Fu(i, [ o.O_(t.S_, Be.exists(!0)) ]);
}
 ...
 */ function Ou(t, ...e) {
    ...
    let a, u, h;
    if (t instanceof Hc) u = Kc(t.firestore, tu), h = oe(t.S_.path), a = {
        next: n => {
            e[o] && e[o](ku(u, t, n));
        },
        error: e[o + 1],
    ...
    return function(t, e, n, s) {
        const i = new Oc(s), r = new Bo(e, i, n);
        return t.fs.ys((async () => Fo(await qa(t), r))), () => {
            i.r_(), t.fs.ys((async () => ko(await qa(t), r)));
        };
    }(eu(u), h, c, a);
}
...
function Fu(t, e) {
    return function(t, e) {
        const n = new ms;
        return t.fs.ys((async () => tc(await Ba(t), e, n))), n.promise;
    }(eu(t), e);
}
 ...
 */ class Mu {
    ...
    set(t, e, n) {
        this.Ed();
        const s = Lu(t, this.zf), i = gu(s.v_, e, n), r = la(this.wd, "WriteBatch.set", s.S_, i, null !== s.v_, n);
        return this.fd.push(r.O_(s.S_, Be.Wt())), this;
    }
    update(t, e, n, ...s) {
        this.Ed();
        ...
        // performing validation.
                let r;
        return e instanceof M && (e = e._), r = "string" == typeof e || e instanceof kc ? ma(this.wd, "WriteBatch.update", i.S_, e, n, s) : Ia(this.wd, "WriteBatch.update", i.S_, e), 
        this.fd.push(r.O_(i.S_, Be.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        ...
        return this.fd = this.fd.concat(new tn(e.S_, Be.Wt())), this;
    }
    /**
    ...
    Ed() {
        if (this.dd) throw new F(O.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}

function Lu(t, e) {
    if (t instanceof M && (t = t._), t.firestore !== e) throw new F(O.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
class $u extends class {
     ...
     */    get(t) {
        const e = Lu(t, this.zf), n = new Vu(this.zf);
        return this.Td.ef([ e.S_ ]).then((t => {
            if (!t || 1 !== t.length) return V();
            const s = t[0];
            if (s instanceof Ot) return new au(this.zf, n, e.S_, null, e.v_);
            if (s instanceof Nt) return new au(this.zf, n, s.key, s, e.v_);
            throw V();
        }));
    }
    set(t, e, n) {
        const s = Lu(t, this.zf), i = gu(s.v_, e, n), r = la(this.wd, "Transaction.set", s.S_, i, null !== s.v_, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return e instanceof M && (e = e._), r = "string" == typeof e || e instanceof kc ? ma(this.wd, "Transaction.update", i.S_, e, n, s) : Ia(this.wd, "Transaction.update", i.S_, e), 
 ...
 */ class qu {
    enableIndexedDbPersistence(t, e) {
        throw new F(O.FAILED_PRECONDITION, Bu);
    }
 ...
 */ class Uu {
    enableIndexedDbPersistence(t, e) {
        return function(t, e) {
            ou(t = Kc(t, tu));
            const n = eu(t), s = t.p_(), i = new xc;
            return su(n, i, new Dc(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
        }
        /**
 ...
 */ (t._, {
    ...
    enableMultiTabIndexedDbPersistence(t) {
        return function(t) {
            ou(t = Kc(t, tu));
            const e = eu(t), n = t.p_(), s = new xc;
            return su(e, s, new Cc(s, n.cacheSizeBytes));
        }(t._);
    }
    clearIndexedDbPersistence(t) {
        return iu(t._);
 ...
 */ class Qu extends M {
    ...
    enableNetwork() {
        return Ua(eu(Kc(this._, tu)));
    }
    disableNetwork() {
        return Qa(eu(Kc(this._, tu)));
    }
    enablePersistence(t) {
        let e = !1, n = !1;
        return t && (e = !!t.synchronizeTabs, n = !!t.experimentalForceOwningTab, Bc("synchronizeTabs", e, "experimentalForceOwningTab", n)), 
    ...
    onSnapshotsInSync(t) {
        return function(t, e) {
            return za(eu(t = Kc(t, tu)), yu(e) ? e : {
                next: e
            });
        }(this._, t);
    }
    get app() {
        if (!this.md) throw new F(O.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.md;
    }
    collection(t) {
        try {
            return new ih(this, Xc(this._, t));
        } catch (t) {
    ...
    doc(t) {
        try {
            return new Hu(this, ta(this._, t));
        } catch (t) {
    ...
    collectionGroup(t) {
        try {
            return new eh(this, Zc(this._, t));
        } catch (t) {
    ...
    batch() {
        return eu(this._), new Gu(new Mu(this._, (t => Fu(this._, t))));
    }
    loadBundle(t) {
        throw new F(O.FAILED_PRECONDITION, '"loadBundle()" does not exist, have you imported "firebase/firestore/bundle"?');
    }
    namedQuery(t) {
        throw new F(O.FAILED_PRECONDITION, '"namedQuery()" does not exist, have you imported "firebase/firestore/bundle"?');
    }
}
...
class Ku extends cu {
    ...
    Qf(t) {
        const e = this.Gf(t, this.firestore.I_);
        return Hu.Ad(e, this.firestore, /* converter= */ null);
    }
}
 ...
 */ class ju extends M {
    constructor(t, e) {
        super(e), this.zf = t, this.Hf = new Ku(t);
    }
    get(t) {
        const e = rh(t);
        return this._.get(e).then((t => new Zu(this.zf, new bu(this.zf._, this.Hf, t.S_, t.Jf, t.metadata, e.v_))));
    }
    set(t, e, n) {
        const s = rh(t);
        return n ? ($c("Transaction.set", n), this._.set(s, e, n)) : this._.set(s, e), this;
    }
    update(t, e, n, ...s) {
        const i = rh(t);
...
class Gu extends M {
    set(t, e, n) {
        const s = rh(t);
        return n ? ($c("WriteBatch.set", n), this._.set(s, e, n)) : this._.set(s, e), this;
    }
    update(t, e, n, ...s) {
        const i = rh(t);
        return 2 === arguments.length ? this._.update(i, e) : this._.update(i, e, n, ...s), 
 ...
 */ class zu extends M {
    constructor(t, e, n) {
        super(n), this.zf = t, this.Hf = e;
    }
    fromFirestore(t, e) {
        const n = new vu(this.zf._, this.Hf, t.S_, t.Jf, t.metadata, 
        /* converter= */ null);
        return this._.fromFirestore(new th(this.zf, n), null != e ? e : {});
    }
    toFirestore(t, e) {
...
class Hu extends M {
    ...
    static yd(t, e, n) {
        if (t.length % 2 != 0) throw new F(O.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t.ot()} has ${t.length}`);
        return new Hu(e, new Hc(e._, n, new et(t)));
    }
    static Ad(t, e, n) {
        return new Hu(e, new Hc(e._, n, t));
    }
    get id() {
        return this._.id;
    }
    get parent() {
        return new ih(this.firestore, this._.parent);
    }
    get path() {
        return this._.path;
    }
    collection(t) {
        try {
            return new ih(this.firestore, Xc(this._, t));
        } catch (t) {
    ...
    set(t, e) {
        e = $c("DocumentReference.set", e);
        try {
            return function(t, e, n) {
                t = Kc(t, Hc);
                const s = Kc(t.firestore, tu), i = gu(t.v_, e, n);
                return Fu(s, [ la(ha(s), "setDoc", t.S_, i, null !== t.v_, n).O_(t.S_, Be.Wt()) ]);
            }(this._, t, e);
        } catch (t) {
    ...
    delete() {
        return Fu(Kc((t = this._).firestore, tu), [ new tn(t.S_, Be.Wt()) ]);
        var t;
        /**
 ...
 */    }
    onSnapshot(...t) {
        const e = Yu(t), n = Xu(t, (t => new Zu(this.firestore, new bu(this.firestore._, this.Hf, t.S_, t.Jf, t.metadata, this._.v_))));
        return Ou(this._, e, n);
    }
    get(t) {
        let e;
        return e = "cache" === (null == t ? void 0 : t.source) ? function(t) {
            t = Kc(t, Hc);
            const e = Kc(t.firestore, tu), n = eu(e), s = new xu(e);
            return Ka(n, t.S_).then((n => new bu(e, s, t.S_, n, new pu(n instanceof Nt && n.bt, 
            /* fromCache= */ !0), t.v_)));
        }
        /**
 ...
 */ (this._) : function(t) {
        ...
        }(this._), e.then((t => new Zu(this.firestore, new bu(this.firestore._, this.Hf, t.S_, t.Jf, t.metadata, this._.v_))));
    }
    withConverter(t) {
        return new Hu(this.firestore, this._.withConverter(zu.Rd(this.firestore, t)));
    }
}
...
class Zu extends M {
    ...
    get ref() {
        return new Hu(this.zf, this._.ref);
    }
    get id() {
        return this._.id;
    }
...
class eh extends M {
    ...
    where(t, e, n) {
        try {
            ...
            return new eh(this.firestore, fu(this._, function(t, e, n) {
    ...
    orderBy(t, e) {
        try {
            ...
            // FieldPath Compat type as input, but is not typed as such in order to
            // not expose this via our public typings file.
            return new eh(this.firestore, fu(this._, function(t, e = "asc") {
    ...
    limit(t) {
        try {
            return new eh(this.firestore, fu(this._, function(t) {
                return Wc("limit", t), new Eu("limit", t, "F" /* First */);
            }
            /**
 ...
 */ (t)));
    ...
    limitToLast(t) {
        try {
            return new eh(this.firestore, fu(this._, function(t) {
                return Wc("limitToLast", t), new Eu("limitToLast", t, "L" /* Last */);
            }(t)));
        } catch (t) {
 ...
 */ (this._) : "server" === (null == t ? void 0 : t.source) ? function(t) {
        ...
        }(this._), e.then((t => new sh(this.firestore, new Su(this.firestore._, this.Hf, this._, t.ud))));
    }
    onSnapshot(...t) {
        const e = Yu(t), n = Xu(t, (t => new sh(this.firestore, new Su(this.firestore._, this.Hf, this._, t.ud))));
        return Ou(this._, e, n);
    }
    withConverter(t) {
        return new eh(this.firestore, this._.withConverter(zu.Rd(this.firestore, t)));
    }
}
...
class nh extends M {
    ...
    get doc() {
        return new th(this.zf, this._.doc);
    }
    get oldIndex() {
...
class sh extends M {
    ...
    get query() {
        return new eh(this.zf, this._.query);
    }
    get metadata() {
        return this._.metadata;
    }
    ...
    get docs() {
        return this._.docs.map((t => new th(this.zf, t)));
    }
    docChanges(t) {
        return this._.docChanges(t).map((t => new nh(this.zf, t)));
    }
    forEach(t, e) {
        this._.forEach((n => {
            t.call(e, new th(this.zf, n));
        }));
    }
    isEqual(t) {
        return Cu(this._, t._);
...
class ih extends eh {
    ...
    doc(t) {
        try {
            return new Hu(this.firestore, void 0 === t ? ta(this._) : ta(this._, t));
        } catch (t) {
    ...
    add(t) {
        return function(t, e) {
            const n = Kc(t.firestore, tu), s = ta(t), i = gu(t.v_, e);
            return Fu(n, [ la(ha(t.firestore), "addDoc", s.S_, i, null !== t.v_, {}).O_(s.S_, Be.exists(!1)) ]).then((() => s));
        }(this._, t).then((t => new Hu(this.firestore, t)));
    }
    isEqual(t) {
        return ea(this._, t._);
    }
    withConverter(t) {
        return new ih(this.firestore, this._.withConverter(zu.Rd(this.firestore, t)));
    }
}

function rh(t) {
    return t instanceof M && (t = t._), Kc(t, Hc);
}
 ...
 */ class oh extends M {
    ...
    static documentId() {
         ...
         * effect is the same.
         */
        return new oh(tt.lt().ot());
    }
    isEqual(t) {
        return t instanceof M && (t = t._), t instanceof kc && this._.d_.isEqual(t.d_);
    }
}
 ...
 */ class ah {
    constructor() {
        this.gd = {}, this.Vd = new ms, this.pd = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
...
function uh(t, e) {
    const n = new ah;
    return Ja(eu(t._), t.I_, e, n), n;
}

function hh(t, e) {
    return Ya(eu(t._), e).then((e => e ? new eh(t, new Jc(t._, null, e.query)) : null));
}

export { $ as Blob, Za as CACHE_SIZE_UNLIMITED, ih as CollectionReference, Hu as DocumentReference, Zu as DocumentSnapshot, tu as ExpFirebaseFirestore, oh as FieldPath, ch as FieldValue, Qu as Firestore, sa as GeoPoint, Uu as IndexedDbPersistenceProvider, qu as MemoryPersistenceProvider, eh as Query, th as QueryDocumentSnapshot, sh as QuerySnapshot, H as Timestamp, ju as Transaction, Gu as WriteBatch, uh as loadBundle, hh as namedQuery, Wu as setLogLevel };
